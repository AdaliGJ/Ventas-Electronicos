--------------------------------------------------------
-- Archivo creado  - viernes-abril-29-2022   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SYSTEM"."FACTURAS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 221 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SYSTEM"."MARCAS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 81 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence MARCAS_SEQ1
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."MARCAS_SEQ1"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence MARCAS_SEQ2
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."MARCAS_SEQ2"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence MARCAS_SEQ3
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."MARCAS_SEQ3"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence MARCAS_SEQ4
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."MARCAS_SEQ4"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SYSTEM"."TIPO_DISPOSITIVO_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 61 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SYSTEM"."VENTAS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 121 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSAUX" ;
--------------------------------------------------------
--  DDL for Table MAPEOTABLA
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."MAPEOTABLA" 
   (	"IDINVENTARIO" NUMBER(*,0), 
	"IDFABRICA" VARCHAR2(30 BYTE), 
	"MARCA" NUMBER(*,0)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."ORDENES_COMPRA" 
   (	"ID_ORDEN" NUMBER(*,0), 
	"ID_CLIENTE" NUMBER(*,0), 
	"CREDITO" CHAR(1 BYTE) DEFAULT 0, 
...
--------------------------------------------------------
--  DDL for Table SMARTWATCH
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."SMARTWATCH" 
   (	"ID_INVENTARIO" NUMBER(*,0), 
	"PULGADAS_PANTALLA" NUMBER(*,0), 
	"SISTEMA_OPERATIVO" VARCHAR2(40 BYTE), 
	"RAM_MB" NUMBER(*,0), 
	"MEMORIA_GB" NUMBER(*,0)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table TELEVISORES
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."TELEVISORES" 
   (	"ID_INVENTARIO" NUMBER(*,0), 
	"RESOLUCION" VARCHAR2(10 BYTE), 
	"BITS_PROFUNDIDAD" NUMBER(*,0), 
	"PULGADAS_PANTALLA" NUMBER(*,0), 
	"ENTRADAS_HDMI" NUMBER(*,0)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table TIPO_CLIENTES
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."TIPO_CLIENTES" 
   (	"ID" NUMBER(*,0), 
	"NOMBRE" VARCHAR2(50 BYTE), 
	"DESCUENTO" NUMBER(*,0)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table TIPO_DISPOSITIVO
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."TIPO_DISPOSITIVO" 
   (	"ID_TIPO_DISPOSITIVO" NUMBER(*,0), 
	"NOMBRE" VARCHAR2(30 BYTE)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table TIPO_USUARIOS
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."TIPO_USUARIOS" 
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table VIDEOJUEGOS
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."VIDEOJUEGOS" 
   (	"ID_INVENTARIO" NUMBER(*,0), 
	"MAX_JUGADORES" NUMBER(*,0), 
	"GRAFICOS" VARCHAR2(20 BYTE), 
	"CONSOLA" VARCHAR2(20 BYTE)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for View CATALOGO
--------------------------------------------------------

  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "SYSTEM"."CATALOGO" ("IDTIPODISPOSITIVO", "TIPODISPOSITIVO", "IDINVENTARIO", "CATEGORIADISPOSITIVO", "MARCA", "EXISTENCIAS", "PRECIOLISTA", "COLOR", "DESCRIPCION", "MODELO", "MESESGARANTIA", "NOMBREMARCA") AS 
  select tdi."IDTIPODISPOSITIVO",tdi."TIPODISPOSITIVO",tdi."IDINVENTARIO",tdi."CATEGORIADISPOSITIVO",tdi."MARCA",tdi."EXISTENCIAS",tdi."PRECIOLISTA",tdi."COLOR",tdi."DESCRIPCION",tdi."MODELO",tdi."MESESGARANTIA", m.nombre nombremarca from (select td.id_tipo_dispositivo idtipodispositivo, td.nombre tipodispositivo , i.id_inventario idinventario, i.categoria_dispositivo categoriadispositivo, i.marca, i.existencias, i.precio_lista preciolista, i.color, i.descripcion, i.modelo, i.meses_garantia mesesgarantia from tipo_dispositivo td inner join inventario i on td.id_tipo_dispositivo=i.categoria_dispositivo) tdi inner join marcas m on tdi.marca = m.id_marca
;
--------------------------------------------------------
--  DDL for View DISPOSITIVOSVENDIDOS
--------------------------------------------------------

  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "SYSTEM"."DISPOSITIVOSVENDIDOS" ("SERIE", "FECHA", "IDPROPIETARIO", "NOMBREPROPIETARIO", "DISPOSITIVO") AS 
  select vc.serie, vc.fecha, vc.id_propietario idpropietario, vc.nombre_propietario nombrepropietario, di.id_inventario dispositivo from (select v.serie, v.fecha, cs.* from (select fc.id_cliente id_propietario, fc.nombre nombre_propietario, o.id_orden from fichas_clientes fc inner join ordenes_compra o on fc.id_cliente=o.id_cliente) cs inner join ventas v on cs.id_orden=v.id_orden) vc inner join dispositivos_individuales di on di.serie_dispositivo = vc.serie
;
--------------------------------------------------------
--  DDL for View IMGS
--------------------------------------------------------

  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "SYSTEM"."IMGS" ("TIPODISPOSITIVO", "NOMBREMARCA", "MODELO", "IDINVENTARIO", "DESCRIPCION", "PRECIOLISTA", "IMAGEN") AS 
  select i.tipodispositivo, i.nombremarca, i.modelo, i.idinventario, i.descripcion, i.preciolista, d.imagen from catalogo i inner join imagenes_dispositivos d on i.idinventario=d.id_inventario
;
--------------------------------------------------------
--  DDL for View INFOCLIENTE
--------------------------------------------------------

  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "SYSTEM"."INFOCLIENTE" ("IDCLIENTE", "TIPOCLIENTE", "NOMBRETIPOCLIENTE", "PATENTE", "VENCIMIENTO", "NOMBRECLIENTE", "NIT") AS 
...
SET DEFINE OFF;
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('787D0D2B036D6933E0530CAAE80A12FB','19573','AQ$_SCHEDULER$_EVENT_QTAB_E','19551','1','0','0','0','0','0','exception queue',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('787D0D2B036E6933E0530CAAE80A12FB','19574','SCHEDULER$_EVENT_QUEUE','19551','0','3','5','0','0','3600','Scheduler event queue',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('787D0D2B03706933E0530CAAE80A12FB','19607','AQ$_SCHEDULER$_REMDB_JOBQTAB_E','19578','1','0','0','0','0','0','exception queue',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('787D0D2B03716933E0530CAAE80A12FB','19608','SCHEDULER$_REMDB_JOBQ','19578','0','3','5','0','0','0','Scheduler remote db job queue',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('787D0D2B03736933E0530CAAE80A12FB','19637','AQ$_SCHEDULER_FILEWATCHER_QT_E','19612','1','0','0','0','0','0','exception queue',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('787D0D2B03746933E0530CAAE80A12FB','19638','SCHEDULER_FILEWATCHER_Q','19612','0','3','5','0','0','0','Scheduler file watcher results queue',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('787D0D2B03756933E0530CAAE80A12FB','19692','AQ$_ALERT_QT_E','19670','1','2','0','0','0','0','exception queue',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('787D0D2B03766933E0530CAAE80A12FB','19693','ALERT_QUE','19670','0','3','5','0','0','0','Server Generated Alert Queue',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('787D0D2B03776933E0530CAAE80A12FB','19950','AQ$_ORA$PREPLUGIN_BACKUP_QTB_E','19928','1','0','0','0','0','0','exception queue',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('787D0D2B03786933E0530CAAE80A12FB','19951','ORA$PREPLUGIN_BACKUP_QUE','19928','0','3','5','0','0','0','SYS.ORA$PREPLUGIN_BACKUP_QUE',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('787D0D2B049D6933E0530CAAE80A12FB','20169','AQ$_AQ$_MEM_MC_E','20145','1','0','0','0','0','0','exception queue',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('787D0D2B049E6933E0530CAAE80A12FB','20170','SRVQUEUE','20145','2','3','0','0','0','0',null,null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('787D0D2B049F6933E0530CAAE80A12FB','20181','AQ$_AQ_EVENT_TABLE_E','20171','1','0','0','0','0','0','exception queue',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('787D0D2B04A06933E0530CAAE80A12FB','20182','AQ_EVENT_TABLE_Q','20171','0','3','5','0','0','0','CREATING AQ_EVENT_TABLE_Q QUEUE',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('787D0D2B04A16933E0530CAAE80A12FB','20205','AQ$_AQ_PROP_TABLE_E','20183','1','0','0','0','0','0','exception queue',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('787D0D2B04A26933E0530CAAE80A12FB','20206','AQ_PROP_NOTIFY','20183','0','3','5','0','0','0','Queue for Notifying events in AQ Prop. Scheduling',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('787D0D2B05C46933E0530CAAE80A12FB','20526','AQ$_SYS$SERVICE_METRICS_TAB_E','20504','1','0','0','0','0','0','exception queue',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('787D0D2B05C56933E0530CAAE80A12FB','20527','SYS$SERVICE_METRICS','20504','0','3','5','0','0','3600',null,null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('787D0D2B07206933E0530CAAE80A12FB','20691','AQ$_PDB_MON_EVENT_QTABLE$_E','20667','1','0','0','0','0','0','exception queue',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('787D0D2B07216933E0530CAAE80A12FB','20692','PDB_MON_EVENT_QUEUE$','20667','0','3','5','0','0','86400','Queue for raw pdb event information',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('787D0D2B07256933E0530CAAE80A12FB','20833','AQ$_CHANGE_LOG_QUEUE_TABLE_E','20811','1','0','0','0','0','0','exception queue',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('787D0D2B07266933E0530CAAE80A12FB','20834','CHANGE_LOG_QUEUE','20811','0','3','5','0','0','0','GSM Change Log Queue',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('787D6814739809EEE0530CAAE80AF038','22551','AQ$_WM$EVENT_QUEUE_TABLE_E','22524','1','0','0','0','0','0','exception queue',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('787D6814739909EEE0530CAAE80AF038','22552','WM$EVENT_QUEUE','22524','0','3','5','0','0','0','OWM Events Queue',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('D9FFF1AB32382723E0530100007F7C4F','73908','AQ$_KUPC$DATAPUMP_QUETAB_1_E','73861','1','0','0','0','0','0','exception queue',null,null,null,null,null,'0','0');
REM INSERTING into SYSTEM.AQ$_QUEUE_TABLES
SET DEFINE OFF;
Insert into SYSTEM.AQ$_QUEUE_TABLES (SCHEMA,NAME,UDATA_TYPE,OBJNO,FLAGS,SORT_COLS,TIMEZONE,TABLE_COMMENT) values ('SYS','SCHEDULER$_EVENT_QTAB','1','19551','16805897','2','00:00','Scheduler event queue table');
Insert into SYSTEM.AQ$_QUEUE_TABLES (SCHEMA,NAME,UDATA_TYPE,OBJNO,FLAGS,SORT_COLS,TIMEZONE,TABLE_COMMENT) values ('SYS','SCHEDULER$_REMDB_JOBQTAB','1','19578','16801801','2','00:00','Scheduler remote db job queue table');
Insert into SYSTEM.AQ$_QUEUE_TABLES (SCHEMA,NAME,UDATA_TYPE,OBJNO,FLAGS,SORT_COLS,TIMEZONE,TABLE_COMMENT) values ('SYS','SCHEDULER_FILEWATCHER_QT','1','19612','16805897','2','00:00','Scheduler file watcher result queue table');
Insert into SYSTEM.AQ$_QUEUE_TABLES (SCHEMA,NAME,UDATA_TYPE,OBJNO,FLAGS,SORT_COLS,TIMEZONE,TABLE_COMMENT) values ('SYS','ALERT_QT','1','19670','16805897','2','00:00','Server Generated Alert Queue Table');
Insert into SYSTEM.AQ$_QUEUE_TABLES (SCHEMA,NAME,UDATA_TYPE,OBJNO,FLAGS,SORT_COLS,TIMEZONE,TABLE_COMMENT) values ('SYS','ORA$PREPLUGIN_BACKUP_QTB','1','19928','16801801','2','00:00','SYS.ORA$PREPLUGIN_BACKUP_QUE');
Insert into SYSTEM.AQ$_QUEUE_TABLES (SCHEMA,NAME,UDATA_TYPE,OBJNO,FLAGS,SORT_COLS,TIMEZONE,TABLE_COMMENT) values ('SYS','AQ$_MEM_MC','3','20145','16801801','2','00:00','table for non_persistent queues');
Insert into SYSTEM.AQ$_QUEUE_TABLES (SCHEMA,NAME,UDATA_TYPE,OBJNO,FLAGS,SORT_COLS,TIMEZONE,TABLE_COMMENT) values ('SYS','AQ_EVENT_TABLE','1','20171','16793600','2','00:00','CREATING AQ_EVENT_TABLE QUEUE TABLE');
Insert into SYSTEM.AQ$_QUEUE_TABLES (SCHEMA,NAME,UDATA_TYPE,OBJNO,FLAGS,SORT_COLS,TIMEZONE,TABLE_COMMENT) values ('SYS','AQ_PROP_TABLE','1','20183','16801801','2','00:00','Queue Table for Notification in AQ Prop. Scheduling');
Insert into SYSTEM.AQ$_QUEUE_TABLES (SCHEMA,NAME,UDATA_TYPE,OBJNO,FLAGS,SORT_COLS,TIMEZONE,TABLE_COMMENT) values ('SYS','SYS$SERVICE_METRICS_TAB','1','20504','16801801','2','00:00',null);
Insert into SYSTEM.AQ$_QUEUE_TABLES (SCHEMA,NAME,UDATA_TYPE,OBJNO,FLAGS,SORT_COLS,TIMEZONE,TABLE_COMMENT) values ('SYS','PDB_MON_EVENT_QTABLE$','1','20667','16801801','2','00:00','Raw queue table containing event information');
Insert into SYSTEM.AQ$_QUEUE_TABLES (SCHEMA,NAME,UDATA_TYPE,OBJNO,FLAGS,SORT_COLS,TIMEZONE,TABLE_COMMENT) values ('GSMADMIN_INTERNAL','CHANGE_LOG_QUEUE_TABLE','1','20811','16801801','2','00:00','Creating GSM change log queue table');
Insert into SYSTEM.AQ$_QUEUE_TABLES (SCHEMA,NAME,UDATA_TYPE,OBJNO,FLAGS,SORT_COLS,TIMEZONE,TABLE_COMMENT) values ('WMSYS','WM$EVENT_QUEUE_TABLE','1','22524','16801801','2','00:00',null);
Insert into SYSTEM.AQ$_QUEUE_TABLES (SCHEMA,NAME,UDATA_TYPE,OBJNO,FLAGS,SORT_COLS,TIMEZONE,TABLE_COMMENT) values ('SYS','KUPC$DATAPUMP_QUETAB_1','1','73861','16793609','2','00:00','DataPump Queue Table');
REM INSERTING into SYSTEM.AQ$_SCHEDULES
SET DEFINE OFF;
REM INSERTING into SYSTEM.CLIENTES
SET DEFINE OFF;
Insert into SYSTEM.CLIENTES (NIT,TIPO_CLIENTE) values ('4567890','2');
Insert into SYSTEM.CLIENTES (NIT,TIPO_CLIENTE) values ('5676892','2');
Insert into SYSTEM.CLIENTES (NIT,TIPO_CLIENTE) values ('5676896','3');
Insert into SYSTEM.CLIENTES (NIT,TIPO_CLIENTE) values ('847329324','3');
REM INSERTING into SYSTEM.DISPOSITIVOS_INDIVIDUALES
SET DEFINE OFF;
Insert into SYSTEM.DISPOSITIVOS_INDIVIDUALES (SERIE_DISPOSITIVO,ID_INVENTARIO,VENDIDO) values ('99504747708883240000','1','1');
Insert into SYSTEM.DISPOSITIVOS_INDIVIDUALES (SERIE_DISPOSITIVO,ID_INVENTARIO,VENDIDO) values ('83007956769194750000','2','1');
Insert into SYSTEM.DISPOSITIVOS_INDIVIDUALES (SERIE_DISPOSITIVO,ID_INVENTARIO,VENDIDO) values ('63301259145945520000','1','1');
Insert into SYSTEM.DISPOSITIVOS_INDIVIDUALES (SERIE_DISPOSITIVO,ID_INVENTARIO,VENDIDO) values ('53486510549528410000','7','1');
Insert into SYSTEM.DISPOSITIVOS_INDIVIDUALES (SERIE_DISPOSITIVO,ID_INVENTARIO,VENDIDO) values ('79786191110871730000','5','1');
Insert into SYSTEM.DISPOSITIVOS_INDIVIDUALES (SERIE_DISPOSITIVO,ID_INVENTARIO,VENDIDO) values ('3134023240474230000','7','0');
Insert into SYSTEM.DISPOSITIVOS_INDIVIDUALES (SERIE_DISPOSITIVO,ID_INVENTARIO,VENDIDO) values ('21803982173834105000','1','3');
Insert into SYSTEM.DISPOSITIVOS_INDIVIDUALES (SERIE_DISPOSITIVO,ID_INVENTARIO,VENDIDO) values ('13085547528200210000','1','3');
Insert into SYSTEM.DISPOSITIVOS_INDIVIDUALES (SERIE_DISPOSITIVO,ID_INVENTARIO,VENDIDO) values ('5852306614879114000','5','0');
Insert into SYSTEM.DISPOSITIVOS_INDIVIDUALES (SERIE_DISPOSITIVO,ID_INVENTARIO,VENDIDO) values ('46033808425557705000','5','3');
Insert into SYSTEM.DISPOSITIVOS_INDIVIDUALES (SERIE_DISPOSITIVO,ID_INVENTARIO,VENDIDO) values ('86202810141252080000','1','3');
Insert into SYSTEM.DISPOSITIVOS_INDIVIDUALES (SERIE_DISPOSITIVO,ID_INVENTARIO,VENDIDO) values ('13735577042514860000','1','3');
Insert into SYSTEM.DISPOSITIVOS_INDIVIDUALES (SERIE_DISPOSITIVO,ID_INVENTARIO,VENDIDO) values ('87172487017252060000','5','0');
Insert into SYSTEM.DISPOSITIVOS_INDIVIDUALES (SERIE_DISPOSITIVO,ID_INVENTARIO,VENDIDO) values ('27574686850057994000','5','0');
Insert into SYSTEM.DISPOSITIVOS_INDIVIDUALES (SERIE_DISPOSITIVO,ID_INVENTARIO,VENDIDO) values ('86271210991290380000','5','0');
Insert into SYSTEM.DISPOSITIVOS_INDIVIDUALES (SERIE_DISPOSITIVO,ID_INVENTARIO,VENDIDO) values ('45237082820379255000','5','0');
Insert into SYSTEM.DISPOSITIVOS_INDIVIDUALES (SERIE_DISPOSITIVO,ID_INVENTARIO,VENDIDO) values ('31126518984554877000','9','1');
Insert into SYSTEM.DISPOSITIVOS_INDIVIDUALES (SERIE_DISPOSITIVO,ID_INVENTARIO,VENDIDO) values ('93343247757675770000','9','1');
Insert into SYSTEM.DISPOSITIVOS_INDIVIDUALES (SERIE_DISPOSITIVO,ID_INVENTARIO,VENDIDO) values ('95228781915232110000','9','1');
Insert into SYSTEM.DISPOSITIVOS_INDIVIDUALES (SERIE_DISPOSITIVO,ID_INVENTARIO,VENDIDO) values ('57764947062847504000','5','3');
REM INSERTING into SYSTEM.FACTURAS
SET DEFINE OFF;
Insert into SYSTEM.FACTURAS (ID_ENTRADA_FACTURA,ID_FACTURA,ID_VENTA,NIT_CLIENTE,PRECIO) values ('181','123456711650333631189','3','1234567','3604.68');
Insert into SYSTEM.FACTURAS (ID_ENTRADA_FACTURA,ID_FACTURA,ID_VENTA,NIT_CLIENTE,PRECIO) values ('182','4111650334031056','4','41','4.005199999999999');
Insert into SYSTEM.FACTURAS (ID_ENTRADA_FACTURA,ID_FACTURA,ID_VENTA,NIT_CLIENTE,PRECIO) values ('201','4131651054784804','5','41','161.950262');
Insert into SYSTEM.FACTURAS (ID_ENTRADA_FACTURA,ID_FACTURA,ID_VENTA,NIT_CLIENTE,PRECIO) values ('41','567689261648889783689','1','5676892','212.04');
Insert into SYSTEM.FACTURAS (ID_ENTRADA_FACTURA,ID_FACTURA,ID_VENTA,NIT_CLIENTE,PRECIO) values ('61','84732932461648921638467','2','847329324','1202.2668');
REM INSERTING into SYSTEM.FICHAS_CLIENTES
SET DEFINE OFF;
Insert into SYSTEM.FICHAS_CLIENTES (NOMBRE,NIT,EMAIL,TELEFONO,PATENTE_DE_COMERCIO,FECHA_DE_VENCIMIENTO) values ('Adalí Garrán Jiménez','5676892','adaligaji@gmail.com','44426699','https://imgv2-1-f.scribdassets.com/img/document/420363071/original/3257a152cc/1647370420?v=1','2023-03-31');
Insert into SYSTEM.FICHAS_CLIENTES (NOMBRE,NIT,EMAIL,TELEFONO,PATENTE_DE_COMERCIO,FECHA_DE_VENCIMIENTO) values ('Gio Cliente','847329324','gio@gmail.com','12345434','https://imgv2-1-f.scribdassets.com/img/document/420363071/original/3257a152cc/1647370420?v=1','2023-04-02');
Insert into SYSTEM.FICHAS_CLIENTES (NOMBRE,NIT,EMAIL,TELEFONO,PATENTE_DE_COMERCIO,FECHA_DE_VENCIMIENTO) values ('Jorge Guerrero','5676896','a@gmail.com','44426699','https://imgv2-1-f.scribdassets.com/img/document/420363071/original/3257a152cc/1647370420?v=1','2023-03-31');
Insert into SYSTEM.FICHAS_CLIENTES (NOMBRE,NIT,EMAIL,TELEFONO,PATENTE_DE_COMERCIO,FECHA_DE_VENCIMIENTO) values ('Javier López','4567890','jlopez@gmail.com','12432522','https://imgv2-1-f.scribdassets.com/img/document/420363071/original/3257a152cc/1647370420?v=1','2023-02-11');
...
REM INSERTING into SYSTEM.IMAGENES_DISPOSITIVOS
SET DEFINE OFF;
Insert into SYSTEM.IMAGENES_DISPOSITIVOS (ID_IMAGEN,ID_INVENTARIO,IMAGEN) values ('5','2','https://www.eluniverso.com/resizer/hMv5jI4dIDDDEDyrVxfOLQnWPSk=/1004x670/smart/filters:quality(70)/cloudfront-us-east-1.images.arcpublishing.com/eluniverso/5ZMYXYI2ORDLLLNE3RORUY33SQ.jpg');
Insert into SYSTEM.IMAGENES_DISPOSITIVOS (ID_IMAGEN,ID_INVENTARIO,IMAGEN) values ('6','2','https://t-mobile.scene7.com/is/image/Tmusprod/fg-iphone-13-pink_750x750_nologo-2?wid=750&hei=750&fmt=png-alpha');
Insert into SYSTEM.IMAGENES_DISPOSITIVOS (ID_IMAGEN,ID_INVENTARIO,IMAGEN) values ('7','3','https://elektragt.vtexassets.com/arquivos/ids/163209-800-auto?v=637505582100630000&width=800&height=auto&aspect=true');
Insert into SYSTEM.IMAGENES_DISPOSITIVOS (ID_IMAGEN,ID_INVENTARIO,IMAGEN) values ('8','3','https://elektragt.vtexassets.com/arquivos/ids/163203-800-auto?v=637505579298700000&width=800&height=auto&aspect=true');
Insert into SYSTEM.IMAGENES_DISPOSITIVOS (ID_IMAGEN,ID_INVENTARIO,IMAGEN) values ('9','3','https://www.lg.com/cac/images/televisores/md07504064/gallery/D-2.jpg');
Insert into SYSTEM.IMAGENES_DISPOSITIVOS (ID_IMAGEN,ID_INVENTARIO,IMAGEN) values ('10','4','https://t-mobile.scene7.com/is/image/Tmusprod/fg-iphone-13-pink_750x750_nologo-2?wid=750&hei=750&fmt=png-alpha');
Insert into SYSTEM.IMAGENES_DISPOSITIVOS (ID_IMAGEN,ID_INVENTARIO,IMAGEN) values ('11','4','https://t-mobile.scene7.com/is/image/Tmusprod/fg-iphone-13-pink_750x750_nologo-2?wid=750&hei=750&fmt=png-alpha');
Insert into SYSTEM.IMAGENES_DISPOSITIVOS (ID_IMAGEN,ID_INVENTARIO,IMAGEN) values ('12','4','https://t-mobile.scene7.com/is/image/Tmusprod/fg-iphone-13-pink_750x750_nologo-2?wid=750&hei=750&fmt=png-alpha');
Insert into SYSTEM.IMAGENES_DISPOSITIVOS (ID_IMAGEN,ID_INVENTARIO,IMAGEN) values ('13','5','https://t-mobile.scene7.com/is/image/Tmusprod/fg-iphone-13-pink_750x750_nologo-2?wid=750&hei=750&fmt=png-alpha');
Insert into SYSTEM.IMAGENES_DISPOSITIVOS (ID_IMAGEN,ID_INVENTARIO,IMAGEN) values ('14','5','https://t-mobile.scene7.com/is/image/Tmusprod/fg-iphone-13-pink_750x750_nologo-2?wid=750&hei=750&fmt=png-alpha');
Insert into SYSTEM.IMAGENES_DISPOSITIVOS (ID_IMAGEN,ID_INVENTARIO,IMAGEN) values ('15','5','https://t-mobile.scene7.com/is/image/Tmusprod/fg-iphone-13-pink_750x750_nologo-2?wid=750&hei=750&fmt=png-alpha');
Insert into SYSTEM.IMAGENES_DISPOSITIVOS (ID_IMAGEN,ID_INVENTARIO,IMAGEN) values ('16','6','https://t-mobile.scene7.com/is/image/Tmusprod/fg-iphone-13-pink_750x750_nologo-2?wid=750&hei=750&fmt=png-alpha');
Insert into SYSTEM.IMAGENES_DISPOSITIVOS (ID_IMAGEN,ID_INVENTARIO,IMAGEN) values ('17','6','https://t-mobile.scene7.com/is/image/Tmusprod/fg-iphone-13-pink_750x750_nologo-2?wid=750&hei=750&fmt=png-alpha');
Insert into SYSTEM.IMAGENES_DISPOSITIVOS (ID_IMAGEN,ID_INVENTARIO,IMAGEN) values ('1','1','https://t-mobile.scene7.com/is/image/Tmusprod/fg-iphone-13-pink_750x750_nologo-2?wid=750&hei=750&fmt=png-alpha');
Insert into SYSTEM.IMAGENES_DISPOSITIVOS (ID_IMAGEN,ID_INVENTARIO,IMAGEN) values ('2','1','https://t-mobile.scene7.com/is/image/Tmusprod/fg-iphone-13-pink_750x750_nologo-2?wid=750&hei=750&fmt=png-alpha');
Insert into SYSTEM.IMAGENES_DISPOSITIVOS (ID_IMAGEN,ID_INVENTARIO,IMAGEN) values ('18','6','https://t-mobile.scene7.com/is/image/Tmusprod/fg-iphone-13-pink_750x750_nologo-2?wid=750&hei=750&fmt=png-alpha');
Insert into SYSTEM.IMAGENES_DISPOSITIVOS (ID_IMAGEN,ID_INVENTARIO,IMAGEN) values ('19','7','https://t-mobile.scene7.com/is/image/Tmusprod/fg-iphone-13-pink_750x750_nologo-2?wid=750&hei=750&fmt=png-alpha');
Insert into SYSTEM.IMAGENES_DISPOSITIVOS (ID_IMAGEN,ID_INVENTARIO,IMAGEN) values ('20','7','https://t-mobile.scene7.com/is/image/Tmusprod/fg-iphone-13-pink_750x750_nologo-2?wid=750&hei=750&fmt=png-alpha');
Insert into SYSTEM.IMAGENES_DISPOSITIVOS (ID_IMAGEN,ID_INVENTARIO,IMAGEN) values ('21','7','https://t-mobile.scene7.com/is/image/Tmusprod/fg-iphone-13-pink_750x750_nologo-2?wid=750&hei=750&fmt=png-alpha');
Insert into SYSTEM.IMAGENES_DISPOSITIVOS (ID_IMAGEN,ID_INVENTARIO,IMAGEN) values ('3','1','https://t-mobile.scene7.com/is/image/Tmusprod/fg-iphone-13-pink_750x750_nologo-2?wid=750&hei=750&fmt=png-alpha');
Insert into SYSTEM.IMAGENES_DISPOSITIVOS (ID_IMAGEN,ID_INVENTARIO,IMAGEN) values ('4','2','https://t-mobile.scene7.com/is/image/Tmusprod/fg-iphone-13-pink_750x750_nologo-2?wid=750&hei=750&fmt=png-alpha');
Insert into SYSTEM.IMAGENES_DISPOSITIVOS (ID_IMAGEN,ID_INVENTARIO,IMAGEN) values ('22','11','https://www.lg.com/cac/images/televisores/md07504064/gallery/D-1.jpg');
Insert into SYSTEM.IMAGENES_DISPOSITIVOS (ID_IMAGEN,ID_INVENTARIO,IMAGEN) values ('23','11','https://www.lg.com/cac/images/televisores/md07504064/gallery/D-1.jpg');
Insert into SYSTEM.IMAGENES_DISPOSITIVOS (ID_IMAGEN,ID_INVENTARIO,IMAGEN) values ('24','11','https://www.lg.com/cac/images/televisores/md07504064/gallery/D-1.jpg');
REM INSERTING into SYSTEM.INVENTARIO
SET DEFINE OFF;
Insert into SYSTEM.INVENTARIO (ID_INVENTARIO,CATEGORIA_DISPOSITIVO,MARCA,EXISTENCIAS,PRECIO_LISTA,COLOR,DESCRIPCION,MODELO,MESES_GARANTIA) values ('3','1','1','0','3293,688','rojo','Tel','rte','23');
Insert into SYSTEM.INVENTARIO (ID_INVENTARIO,CATEGORIA_DISPOSITIVO,MARCA,EXISTENCIAS,PRECIO_LISTA,COLOR,DESCRIPCION,MODELO,MESES_GARANTIA) values ('4','4','1','0','30,628','amarillo','g','1dr','23');
Insert into SYSTEM.INVENTARIO (ID_INVENTARIO,CATEGORIA_DISPOSITIVO,MARCA,EXISTENCIAS,PRECIO_LISTA,COLOR,DESCRIPCION,MODELO,MESES_GARANTIA) values ('5','5','1','0','4,712','4r','45','34','2');
Insert into SYSTEM.INVENTARIO (ID_INVENTARIO,CATEGORIA_DISPOSITIVO,MARCA,EXISTENCIAS,PRECIO_LISTA,COLOR,DESCRIPCION,MODELO,MESES_GARANTIA) values ('6','7','1','0','183,768','1','ffe','1','1');
Insert into SYSTEM.INVENTARIO (ID_INVENTARIO,CATEGORIA_DISPOSITIVO,MARCA,EXISTENCIAS,PRECIO_LISTA,COLOR,DESCRIPCION,MODELO,MESES_GARANTIA) values ('7','1','46','0','1335,852','rojo','sadsad','4563','30');
Insert into SYSTEM.INVENTARIO (ID_INVENTARIO,CATEGORIA_DISPOSITIVO,MARCA,EXISTENCIAS,PRECIO_LISTA,COLOR,DESCRIPCION,MODELO,MESES_GARANTIA) values ('8','2','2','0','106,02','rojo','ddff','1111','3');
Insert into SYSTEM.INVENTARIO (ID_INVENTARIO,CATEGORIA_DISPOSITIVO,MARCA,EXISTENCIAS,PRECIO_LISTA,COLOR,DESCRIPCION,MODELO,MESES_GARANTIA) values ('9','2','2','0','801,04','rojo','Video Juego','x45f','12');
Insert into SYSTEM.INVENTARIO (ID_INVENTARIO,CATEGORIA_DISPOSITIVO,MARCA,EXISTENCIAS,PRECIO_LISTA,COLOR,DESCRIPCION,MODELO,MESES_GARANTIA) values ('10','1','48','0','329858,848','Negro8','Plasma8','82021','14');
Insert into SYSTEM.INVENTARIO (ID_INVENTARIO,CATEGORIA_DISPOSITIVO,MARCA,EXISTENCIAS,PRECIO_LISTA,COLOR,DESCRIPCION,MODELO,MESES_GARANTIA) values ('1','4','1','0','190,52972','rojo','rojo','1234','45');
Insert into SYSTEM.INVENTARIO (ID_INVENTARIO,CATEGORIA_DISPOSITIVO,MARCA,EXISTENCIAS,PRECIO_LISTA,COLOR,DESCRIPCION,MODELO,MESES_GARANTIA) values ('2','2','2','0','235,6','rojo','Desc','xer','24');
Insert into SYSTEM.INVENTARIO (ID_INVENTARIO,CATEGORIA_DISPOSITIVO,MARCA,EXISTENCIAS,PRECIO_LISTA,COLOR,DESCRIPCION,MODELO,MESES_GARANTIA) values ('11','2','46','0','15804,048','Indefinido8','Juego usado8','20148','12');
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.MAPEOTABLA
SET DEFINE OFF;
Insert into SYSTEM.MAPEOTABLA (IDINVENTARIO,IDFABRICA,MARCA) values ('2','6242b248b67160bc5d2ebed7','46');
REM INSERTING into SYSTEM.MARCAS
SET DEFINE OFF;
Insert into SYSTEM.MARCAS (ID_MARCA,NOMBRE,IP) values ('1','Samsung','localhost');
Insert into SYSTEM.MARCAS (ID_MARCA,NOMBRE,IP) values ('2','LG','localhost');
Insert into SYSTEM.MARCAS (ID_MARCA,NOMBRE,IP) values ('46','Nintendo','localhost');
Insert into SYSTEM.MARCAS (ID_MARCA,NOMBRE,IP) values ('47','Acer','localhost');
Insert into SYSTEM.MARCAS (ID_MARCA,NOMBRE,IP) values ('48','Huaweii','localhost');
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.ORDENES_COMPRA
SET DEFINE OFF;
Insert into SYSTEM.ORDENES_COMPRA (ID_ORDEN,ID_CLIENTE,CREDITO,ENTREGA_ESTIMADA,PRECIO,FECHA) values ('3','1234567','0',null,'3604.68','18-3-2022');
Insert into SYSTEM.ORDENES_COMPRA (ID_ORDEN,ID_CLIENTE,CREDITO,ENTREGA_ESTIMADA,PRECIO,FECHA) values ('4','41','1',null,'4.005199999999999','18-3-2022');
Insert into SYSTEM.ORDENES_COMPRA (ID_ORDEN,ID_CLIENTE,CREDITO,ENTREGA_ESTIMADA,PRECIO,FECHA) values ('5','41','1',null,'161.950262','27-3-2022');
Insert into SYSTEM.ORDENES_COMPRA (ID_ORDEN,ID_CLIENTE,CREDITO,ENTREGA_ESTIMADA,PRECIO,FECHA) values ('1','5676892','0',null,'212.04','2-3-2022');
Insert into SYSTEM.ORDENES_COMPRA (ID_ORDEN,ID_CLIENTE,CREDITO,ENTREGA_ESTIMADA,PRECIO,FECHA) values ('2','847329324','0',null,'1202.2668','2-3-2022');
REM INSERTING into SYSTEM.PEDIDOS
SET DEFINE OFF;
Insert into SYSTEM.PEDIDOS (IDPEDIDO,FECHA,IDINVENTARIO,CANTIDAD,ESTADO,FECHAENTREGA) values ('1','16-3-2022','4','5','recibido',null);
Insert into SYSTEM.PEDIDOS (IDPEDIDO,FECHA,IDINVENTARIO,CANTIDAD,ESTADO,FECHAENTREGA) values ('2','16-3-2022','4','5','entregado',null);
Insert into SYSTEM.PEDIDOS (IDPEDIDO,FECHA,IDINVENTARIO,CANTIDAD,ESTADO,FECHAENTREGA) values ('3','16-3-2022','2','99','registrado',null);
Insert into SYSTEM.PEDIDOS (IDPEDIDO,FECHA,IDINVENTARIO,CANTIDAD,ESTADO,FECHAENTREGA) values ('4','16-3-2022','4','66','registrado',null);
Insert into SYSTEM.PEDIDOS (IDPEDIDO,FECHA,IDINVENTARIO,CANTIDAD,ESTADO,FECHAENTREGA) values ('5','17-3-2022','5','1','entregado','1651119127468');
Insert into SYSTEM.PEDIDOS (IDPEDIDO,FECHA,IDINVENTARIO,CANTIDAD,ESTADO,FECHAENTREGA) values ('6','17-3-2022','5','1','registrado',null);
Insert into SYSTEM.PEDIDOS (IDPEDIDO,FECHA,IDINVENTARIO,CANTIDAD,ESTADO,FECHAENTREGA) values ('7','17-3-2022','5','1','registrado',null);
Insert into SYSTEM.PEDIDOS (IDPEDIDO,FECHA,IDINVENTARIO,CANTIDAD,ESTADO,FECHAENTREGA) values ('8','17-3-2022','5','1','registrado',null);
Insert into SYSTEM.PEDIDOS (IDPEDIDO,FECHA,IDINVENTARIO,CANTIDAD,ESTADO,FECHAENTREGA) values ('9','17-3-2022','5','1','registrado',null);
Insert into SYSTEM.PEDIDOS (IDPEDIDO,FECHA,IDINVENTARIO,CANTIDAD,ESTADO,FECHAENTREGA) values ('10','17-3-2022','5','1','registrado',null);
Insert into SYSTEM.PEDIDOS (IDPEDIDO,FECHA,IDINVENTARIO,CANTIDAD,ESTADO,FECHAENTREGA) values ('11','17-3-2022','3','1','registrado',null);
Insert into SYSTEM.PEDIDOS (IDPEDIDO,FECHA,IDINVENTARIO,CANTIDAD,ESTADO,FECHAENTREGA) values ('12','17-3-2022','3','1','registrado',null);
Insert into SYSTEM.PEDIDOS (IDPEDIDO,FECHA,IDINVENTARIO,CANTIDAD,ESTADO,FECHAENTREGA) values ('13','17-3-2022','3','1','registrado',null);
Insert into SYSTEM.PEDIDOS (IDPEDIDO,FECHA,IDINVENTARIO,CANTIDAD,ESTADO,FECHAENTREGA) values ('14','17-3-2022','3','2','registrado',null);
Insert into SYSTEM.PEDIDOS (IDPEDIDO,FECHA,IDINVENTARIO,CANTIDAD,ESTADO,FECHAENTREGA) values ('15','17-3-2022','3','1','registrado',null);
Insert into SYSTEM.PEDIDOS (IDPEDIDO,FECHA,IDINVENTARIO,CANTIDAD,ESTADO,FECHAENTREGA) values ('16','17-3-2022','3','4','registrado',null);
Insert into SYSTEM.PEDIDOS (IDPEDIDO,FECHA,IDINVENTARIO,CANTIDAD,ESTADO,FECHAENTREGA) values ('17','17-3-2022','3','1','registrado',null);
Insert into SYSTEM.PEDIDOS (IDPEDIDO,FECHA,IDINVENTARIO,CANTIDAD,ESTADO,FECHAENTREGA) values ('18','17-3-2022','3','4','registrado',null);
Insert into SYSTEM.PEDIDOS (IDPEDIDO,FECHA,IDINVENTARIO,CANTIDAD,ESTADO,FECHAENTREGA) values ('19','17-3-2022','3','4','registrado',null);
Insert into SYSTEM.PEDIDOS (IDPEDIDO,FECHA,IDINVENTARIO,CANTIDAD,ESTADO,FECHAENTREGA) values ('20','17-3-2022','2','4','cancelado',null);
Insert into SYSTEM.PEDIDOS (IDPEDIDO,FECHA,IDINVENTARIO,CANTIDAD,ESTADO,FECHAENTREGA) values ('21','18-3-2022','5','4','recibido',null);
Insert into SYSTEM.PEDIDOS (IDPEDIDO,FECHA,IDINVENTARIO,CANTIDAD,ESTADO,FECHAENTREGA) values ('22','18-3-2022','3','2','cancelado',null);
Insert into SYSTEM.PEDIDOS (IDPEDIDO,FECHA,IDINVENTARIO,CANTIDAD,ESTADO,FECHAENTREGA) values ('23','18-3-2022','9','3','recibido',null);
Insert into SYSTEM.PEDIDOS (IDPEDIDO,FECHA,IDINVENTARIO,CANTIDAD,ESTADO,FECHAENTREGA) values ('24','18-3-2022','9','2','registrado',null);
Insert into SYSTEM.PEDIDOS (IDPEDIDO,FECHA,IDINVENTARIO,CANTIDAD,ESTADO,FECHAENTREGA) values ('25','18-3-2022','5','1','registrado',null);
Insert into SYSTEM.PEDIDOS (IDPEDIDO,FECHA,IDINVENTARIO,CANTIDAD,ESTADO,FECHAENTREGA) values ('26','18-3-2022','7','5','cancelado',null);
Insert into SYSTEM.PEDIDOS (IDPEDIDO,FECHA,IDINVENTARIO,CANTIDAD,ESTADO,FECHAENTREGA) values ('27','27-3-2022','1','1','registrado',null);
Insert into SYSTEM.PEDIDOS (IDPEDIDO,FECHA,IDINVENTARIO,CANTIDAD,ESTADO,FECHAENTREGA) values ('28','27-3-2022','1','0','registrado',null);
Insert into SYSTEM.PEDIDOS (IDPEDIDO,FECHA,IDINVENTARIO,CANTIDAD,ESTADO,FECHAENTREGA) values ('29','28-3-2022','3','2','registrado',null);
Insert into SYSTEM.PEDIDOS (IDPEDIDO,FECHA,IDINVENTARIO,CANTIDAD,ESTADO,FECHAENTREGA) values ('30','28-3-2022','2','1','cancelado',null);
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.SMARTWATCH
SET DEFINE OFF;
REM INSERTING into SYSTEM.SQLPLUS_PRODUCT_PROFILE
SET DEFINE OFF;
REM INSERTING into SYSTEM.TELEVISORES
SET DEFINE OFF;
Insert into SYSTEM.TELEVISORES (ID_INVENTARIO,RESOLUCION,BITS_PROFUNDIDAD,PULGADAS_PANTALLA,ENTRADAS_HDMI) values ('3','alta','64','24','2');
Insert into SYSTEM.TELEVISORES (ID_INVENTARIO,RESOLUCION,BITS_PROFUNDIDAD,PULGADAS_PANTALLA,ENTRADAS_HDMI) values ('7','1','1','50','2');
REM INSERTING into SYSTEM.TIPO_CLIENTES
SET DEFINE OFF;
Insert into SYSTEM.TIPO_CLIENTES (ID,NOMBRE,DESCUENTO) values ('1','Individual','0');
Insert into SYSTEM.TIPO_CLIENTES (ID,NOMBRE,DESCUENTO) values ('2','Grande','10');
Insert into SYSTEM.TIPO_CLIENTES (ID,NOMBRE,DESCUENTO) values ('3','Mayorista','15');
REM INSERTING into SYSTEM.TIPO_DISPOSITIVO
SET DEFINE OFF;
Insert into SYSTEM.TIPO_DISPOSITIVO (ID_TIPO_DISPOSITIVO,NOMBRE) values ('41','Electrodoméstico');
...
REM INSERTING into SYSTEM.TIPO_USUARIOS
SET DEFINE OFF;
Insert into SYSTEM.TIPO_USUARIOS (ID_TIPO_USUARIO,NOMBRE) values ('1','Administrador');
Insert into SYSTEM.TIPO_USUARIOS (ID_TIPO_USUARIO,NOMBRE) values ('2','Vendedor');
REM INSERTING into SYSTEM.USUARIOS
SET DEFINE OFF;
Insert into SYSTEM.USUARIOS (ID_USUARIO,TIPO_USUARIO,PASSWORD,NOMBRE) values ('1','2','1234','luis');
Insert into SYSTEM.USUARIOS (ID_USUARIO,TIPO_USUARIO,PASSWORD,NOMBRE) values ('5675467','1','1234','Jorge Guerrero');
Insert into SYSTEM.USUARIOS (ID_USUARIO,TIPO_USUARIO,PASSWORD,NOMBRE) values ('678956','2','123','Gio');
Insert into SYSTEM.USUARIOS (ID_USUARIO,TIPO_USUARIO,PASSWORD,NOMBRE) values ('897654','2','1234','Adalì Garràn');
REM INSERTING into SYSTEM.VENTAS
SET DEFINE OFF;
Insert into SYSTEM.VENTAS (ID_VENTA,ID_ORDEN,SERIE,CREDITO,FECHA) values ('83','2','31126518984554877000','0','18-3-2022');
Insert into SYSTEM.VENTAS (ID_VENTA,ID_ORDEN,SERIE,CREDITO,FECHA) values ('81','2','93343247757675770000','0','18-3-2022');
Insert into SYSTEM.VENTAS (ID_VENTA,ID_ORDEN,SERIE,CREDITO,FECHA) values ('1','1','53486510549528410000','0','22-03-2022');
Insert into SYSTEM.VENTAS (ID_VENTA,ID_ORDEN,SERIE,CREDITO,FECHA) values ('84','3','79786191110871730000','1','18-3-2022');
Insert into SYSTEM.VENTAS (ID_VENTA,ID_ORDEN,SERIE,CREDITO,FECHA) values ('101','4','63301259145945520000','1','27-3-2022');
Insert into SYSTEM.VENTAS (ID_VENTA,ID_ORDEN,SERIE,CREDITO,FECHA) values ('82','2','95228781915232110000','0','18-3-2022');
REM INSERTING into SYSTEM.VIDEOJUEGOS
SET DEFINE OFF;
Insert into SYSTEM.VIDEOJUEGOS (ID_INVENTARIO,MAX_JUGADORES,GRAFICOS,CONSOLA) values ('9','2','1234','Gio Station');
Insert into SYSTEM.VIDEOJUEGOS (ID_INVENTARIO,MAX_JUGADORES,GRAFICOS,CONSOLA) values ('2','1','Altos','Nintendo');
Insert into SYSTEM.VIDEOJUEGOS (ID_INVENTARIO,MAX_JUGADORES,GRAFICOS,CONSOLA) values ('8','2','45e','Nintendo');
Insert into SYSTEM.VIDEOJUEGOS (ID_INVENTARIO,MAX_JUGADORES,GRAFICOS,CONSOLA) values ('11','2','131','Nintendo Wii');
REM INSERTING into SYSTEM.CATALOGO
SET DEFINE OFF;
Insert into SYSTEM.CATALOGO (IDTIPODISPOSITIVO,TIPODISPOSITIVO,IDINVENTARIO,CATEGORIADISPOSITIVO,MARCA,EXISTENCIAS,PRECIOLISTA,COLOR,DESCRIPCION,MODELO,MESESGARANTIA,NOMBREMARCA) values ('1','Televisor','3','1','1','0','3293,688','rojo','Tel','rte','23','Samsung');
Insert into SYSTEM.CATALOGO (IDTIPODISPOSITIVO,TIPODISPOSITIVO,IDINVENTARIO,CATEGORIADISPOSITIVO,MARCA,EXISTENCIAS,PRECIOLISTA,COLOR,DESCRIPCION,MODELO,MESESGARANTIA,NOMBREMARCA) values ('1','Televisor','7','1','46','0','1335,852','rojo','sadsad','4563','30','Nintendo');
Insert into SYSTEM.CATALOGO (IDTIPODISPOSITIVO,TIPODISPOSITIVO,IDINVENTARIO,CATEGORIADISPOSITIVO,MARCA,EXISTENCIAS,PRECIOLISTA,COLOR,DESCRIPCION,MODELO,MESESGARANTIA,NOMBREMARCA) values ('1','Televisor','10','1','48','0','329858,848','Negro8','Plasma8','82021','14','Huaweii');
Insert into SYSTEM.CATALOGO (IDTIPODISPOSITIVO,TIPODISPOSITIVO,IDINVENTARIO,CATEGORIADISPOSITIVO,MARCA,EXISTENCIAS,PRECIOLISTA,COLOR,DESCRIPCION,MODELO,MESESGARANTIA,NOMBREMARCA) values ('2','Videojuego','8','2','2','0','106,02','rojo','ddff','1111','3','LG');
Insert into SYSTEM.CATALOGO (IDTIPODISPOSITIVO,TIPODISPOSITIVO,IDINVENTARIO,CATEGORIADISPOSITIVO,MARCA,EXISTENCIAS,PRECIOLISTA,COLOR,DESCRIPCION,MODELO,MESESGARANTIA,NOMBREMARCA) values ('2','Videojuego','9','2','2','0','801,04','rojo','Video Juego','x45f','12','LG');
Insert into SYSTEM.CATALOGO (IDTIPODISPOSITIVO,TIPODISPOSITIVO,IDINVENTARIO,CATEGORIADISPOSITIVO,MARCA,EXISTENCIAS,PRECIOLISTA,COLOR,DESCRIPCION,MODELO,MESESGARANTIA,NOMBREMARCA) values ('2','Videojuego','2','2','2','0','235,6','rojo','Desc','xer','24','LG');
Insert into SYSTEM.CATALOGO (IDTIPODISPOSITIVO,TIPODISPOSITIVO,IDINVENTARIO,CATEGORIADISPOSITIVO,MARCA,EXISTENCIAS,PRECIOLISTA,COLOR,DESCRIPCION,MODELO,MESESGARANTIA,NOMBREMARCA) values ('2','Videojuego','11','2','46','0','15804,048','Indefinido8','Juego usado8','20148','12','Nintendo');
Insert into SYSTEM.CATALOGO (IDTIPODISPOSITIVO,TIPODISPOSITIVO,IDINVENTARIO,CATEGORIADISPOSITIVO,MARCA,EXISTENCIAS,PRECIOLISTA,COLOR,DESCRIPCION,MODELO,MESESGARANTIA,NOMBREMARCA) values ('4','Computadora','4','4','1','0','30,628','amarillo','g','1dr','23','Samsung');
Insert into SYSTEM.CATALOGO (IDTIPODISPOSITIVO,TIPODISPOSITIVO,IDINVENTARIO,CATEGORIADISPOSITIVO,MARCA,EXISTENCIAS,PRECIOLISTA,COLOR,DESCRIPCION,MODELO,MESESGARANTIA,NOMBREMARCA) values ('4','Computadora','1','4','1','0','190,52972','rojo','rojo','1234','45','Samsung');
Insert into SYSTEM.CATALOGO (IDTIPODISPOSITIVO,TIPODISPOSITIVO,IDINVENTARIO,CATEGORIADISPOSITIVO,MARCA,EXISTENCIAS,PRECIOLISTA,COLOR,DESCRIPCION,MODELO,MESESGARANTIA,NOMBREMARCA) values ('5','Monitor','5','5','1','0','4,712','4r','45','34','2','Samsung');
Insert into SYSTEM.CATALOGO (IDTIPODISPOSITIVO,TIPODISPOSITIVO,IDINVENTARIO,CATEGORIADISPOSITIVO,MARCA,EXISTENCIAS,PRECIOLISTA,COLOR,DESCRIPCION,MODELO,MESESGARANTIA,NOMBREMARCA) values ('7','Equipo de Sonido','6','7','1','0','183,768','1','ffe','1','1','Samsung');
REM INSERTING into SYSTEM.DISPOSITIVOSVENDIDOS
SET DEFINE OFF;
REM INSERTING into SYSTEM.IMGS
SET DEFINE OFF;
Insert into SYSTEM.IMGS (TIPODISPOSITIVO,NOMBREMARCA,MODELO,IDINVENTARIO,DESCRIPCION,PRECIOLISTA,IMAGEN) values ('Videojuego','LG','xer','2','Desc','235,6','https://www.eluniverso.com/resizer/hMv5jI4dIDDDEDyrVxfOLQnWPSk=/1004x670/smart/filters:quality(70)/cloudfront-us-east-1.images.arcpublishing.com/eluniverso/5ZMYXYI2ORDLLLNE3RORUY33SQ.jpg');
Insert into SYSTEM.IMGS (TIPODISPOSITIVO,NOMBREMARCA,MODELO,IDINVENTARIO,DESCRIPCION,PRECIOLISTA,IMAGEN) values ('Videojuego','LG','xer','2','Desc','235,6','https://t-mobile.scene7.com/is/image/Tmusprod/fg-iphone-13-pink_750x750_nologo-2?wid=750&hei=750&fmt=png-alpha');
Insert into SYSTEM.IMGS (TIPODISPOSITIVO,NOMBREMARCA,MODELO,IDINVENTARIO,DESCRIPCION,PRECIOLISTA,IMAGEN) values ('Televisor','Samsung','rte','3','Tel','3293,688','https://elektragt.vtexassets.com/arquivos/ids/163209-800-auto?v=637505582100630000&width=800&height=auto&aspect=true');
Insert into SYSTEM.IMGS (TIPODISPOSITIVO,NOMBREMARCA,MODELO,IDINVENTARIO,DESCRIPCION,PRECIOLISTA,IMAGEN) values ('Televisor','Samsung','rte','3','Tel','3293,688','https://elektragt.vtexassets.com/arquivos/ids/163203-800-auto?v=637505579298700000&width=800&height=auto&aspect=true');
Insert into SYSTEM.IMGS (TIPODISPOSITIVO,NOMBREMARCA,MODELO,IDINVENTARIO,DESCRIPCION,PRECIOLISTA,IMAGEN) values ('Televisor','Samsung','rte','3','Tel','3293,688','https://www.lg.com/cac/images/televisores/md07504064/gallery/D-2.jpg');
Insert into SYSTEM.IMGS (TIPODISPOSITIVO,NOMBREMARCA,MODELO,IDINVENTARIO,DESCRIPCION,PRECIOLISTA,IMAGEN) values ('Computadora','Samsung','1dr','4','g','30,628','https://t-mobile.scene7.com/is/image/Tmusprod/fg-iphone-13-pink_750x750_nologo-2?wid=750&hei=750&fmt=png-alpha');
Insert into SYSTEM.IMGS (TIPODISPOSITIVO,NOMBREMARCA,MODELO,IDINVENTARIO,DESCRIPCION,PRECIOLISTA,IMAGEN) values ('Computadora','Samsung','1dr','4','g','30,628','https://t-mobile.scene7.com/is/image/Tmusprod/fg-iphone-13-pink_750x750_nologo-2?wid=750&hei=750&fmt=png-alpha');
Insert into SYSTEM.IMGS (TIPODISPOSITIVO,NOMBREMARCA,MODELO,IDINVENTARIO,DESCRIPCION,PRECIOLISTA,IMAGEN) values ('Computadora','Samsung','1dr','4','g','30,628','https://t-mobile.scene7.com/is/image/Tmusprod/fg-iphone-13-pink_750x750_nologo-2?wid=750&hei=750&fmt=png-alpha');
Insert into SYSTEM.IMGS (TIPODISPOSITIVO,NOMBREMARCA,MODELO,IDINVENTARIO,DESCRIPCION,PRECIOLISTA,IMAGEN) values ('Monitor','Samsung','34','5','45','4,712','https://t-mobile.scene7.com/is/image/Tmusprod/fg-iphone-13-pink_750x750_nologo-2?wid=750&hei=750&fmt=png-alpha');
Insert into SYSTEM.IMGS (TIPODISPOSITIVO,NOMBREMARCA,MODELO,IDINVENTARIO,DESCRIPCION,PRECIOLISTA,IMAGEN) values ('Monitor','Samsung','34','5','45','4,712','https://t-mobile.scene7.com/is/image/Tmusprod/fg-iphone-13-pink_750x750_nologo-2?wid=750&hei=750&fmt=png-alpha');
Insert into SYSTEM.IMGS (TIPODISPOSITIVO,NOMBREMARCA,MODELO,IDINVENTARIO,DESCRIPCION,PRECIOLISTA,IMAGEN) values ('Monitor','Samsung','34','5','45','4,712','https://t-mobile.scene7.com/is/image/Tmusprod/fg-iphone-13-pink_750x750_nologo-2?wid=750&hei=750&fmt=png-alpha');
Insert into SYSTEM.IMGS (TIPODISPOSITIVO,NOMBREMARCA,MODELO,IDINVENTARIO,DESCRIPCION,PRECIOLISTA,IMAGEN) values ('Equipo de Sonido','Samsung','1','6','ffe','183,768','https://t-mobile.scene7.com/is/image/Tmusprod/fg-iphone-13-pink_750x750_nologo-2?wid=750&hei=750&fmt=png-alpha');
Insert into SYSTEM.IMGS (TIPODISPOSITIVO,NOMBREMARCA,MODELO,IDINVENTARIO,DESCRIPCION,PRECIOLISTA,IMAGEN) values ('Equipo de Sonido','Samsung','1','6','ffe','183,768','https://t-mobile.scene7.com/is/image/Tmusprod/fg-iphone-13-pink_750x750_nologo-2?wid=750&hei=750&fmt=png-alpha');
Insert into SYSTEM.IMGS (TIPODISPOSITIVO,NOMBREMARCA,MODELO,IDINVENTARIO,DESCRIPCION,PRECIOLISTA,IMAGEN) values ('Computadora','Samsung','1234','1','rojo','190,52972','https://t-mobile.scene7.com/is/image/Tmusprod/fg-iphone-13-pink_750x750_nologo-2?wid=750&hei=750&fmt=png-alpha');
Insert into SYSTEM.IMGS (TIPODISPOSITIVO,NOMBREMARCA,MODELO,IDINVENTARIO,DESCRIPCION,PRECIOLISTA,IMAGEN) values ('Computadora','Samsung','1234','1','rojo','190,52972','https://t-mobile.scene7.com/is/image/Tmusprod/fg-iphone-13-pink_750x750_nologo-2?wid=750&hei=750&fmt=png-alpha');
Insert into SYSTEM.IMGS (TIPODISPOSITIVO,NOMBREMARCA,MODELO,IDINVENTARIO,DESCRIPCION,PRECIOLISTA,IMAGEN) values ('Equipo de Sonido','Samsung','1','6','ffe','183,768','https://t-mobile.scene7.com/is/image/Tmusprod/fg-iphone-13-pink_750x750_nologo-2?wid=750&hei=750&fmt=png-alpha');
Insert into SYSTEM.IMGS (TIPODISPOSITIVO,NOMBREMARCA,MODELO,IDINVENTARIO,DESCRIPCION,PRECIOLISTA,IMAGEN) values ('Televisor','Nintendo','4563','7','sadsad','1335,852','https://t-mobile.scene7.com/is/image/Tmusprod/fg-iphone-13-pink_750x750_nologo-2?wid=750&hei=750&fmt=png-alpha');
Insert into SYSTEM.IMGS (TIPODISPOSITIVO,NOMBREMARCA,MODELO,IDINVENTARIO,DESCRIPCION,PRECIOLISTA,IMAGEN) values ('Televisor','Nintendo','4563','7','sadsad','1335,852','https://t-mobile.scene7.com/is/image/Tmusprod/fg-iphone-13-pink_750x750_nologo-2?wid=750&hei=750&fmt=png-alpha');
Insert into SYSTEM.IMGS (TIPODISPOSITIVO,NOMBREMARCA,MODELO,IDINVENTARIO,DESCRIPCION,PRECIOLISTA,IMAGEN) values ('Televisor','Nintendo','4563','7','sadsad','1335,852','https://t-mobile.scene7.com/is/image/Tmusprod/fg-iphone-13-pink_750x750_nologo-2?wid=750&hei=750&fmt=png-alpha');
Insert into SYSTEM.IMGS (TIPODISPOSITIVO,NOMBREMARCA,MODELO,IDINVENTARIO,DESCRIPCION,PRECIOLISTA,IMAGEN) values ('Computadora','Samsung','1234','1','rojo','190,52972','https://t-mobile.scene7.com/is/image/Tmusprod/fg-iphone-13-pink_750x750_nologo-2?wid=750&hei=750&fmt=png-alpha');
Insert into SYSTEM.IMGS (TIPODISPOSITIVO,NOMBREMARCA,MODELO,IDINVENTARIO,DESCRIPCION,PRECIOLISTA,IMAGEN) values ('Videojuego','LG','xer','2','Desc','235,6','https://t-mobile.scene7.com/is/image/Tmusprod/fg-iphone-13-pink_750x750_nologo-2?wid=750&hei=750&fmt=png-alpha');
Insert into SYSTEM.IMGS (TIPODISPOSITIVO,NOMBREMARCA,MODELO,IDINVENTARIO,DESCRIPCION,PRECIOLISTA,IMAGEN) values ('Videojuego','Nintendo','20148','11','Juego usado8','15804,048','https://www.lg.com/cac/images/televisores/md07504064/gallery/D-1.jpg');
Insert into SYSTEM.IMGS (TIPODISPOSITIVO,NOMBREMARCA,MODELO,IDINVENTARIO,DESCRIPCION,PRECIOLISTA,IMAGEN) values ('Videojuego','Nintendo','20148','11','Juego usado8','15804,048','https://www.lg.com/cac/images/televisores/md07504064/gallery/D-1.jpg');
Insert into SYSTEM.IMGS (TIPODISPOSITIVO,NOMBREMARCA,MODELO,IDINVENTARIO,DESCRIPCION,PRECIOLISTA,IMAGEN) values ('Videojuego','Nintendo','20148','11','Juego usado8','15804,048','https://www.lg.com/cac/images/televisores/md07504064/gallery/D-1.jpg');
REM INSERTING into SYSTEM.INFOCLIENTE
SET DEFINE OFF;
Insert into SYSTEM.INFOCLIENTE (IDCLIENTE,TIPOCLIENTE,NOMBRETIPOCLIENTE,PATENTE,VENCIMIENTO,NOMBRECLIENTE,NIT) values ('5676892','2','Grande','https://imgv2-1-f.scribdassets.com/img/document/420363071/original/3257a152cc/1647370420?v=1','2023-03-31','Adalí Garrán Jiménez','5676892');
Insert into SYSTEM.INFOCLIENTE (IDCLIENTE,TIPOCLIENTE,NOMBRETIPOCLIENTE,PATENTE,VENCIMIENTO,NOMBRECLIENTE,NIT) values ('847329324','3','Mayorista','https://imgv2-1-f.scribdassets.com/img/document/420363071/original/3257a152cc/1647370420?v=1','2023-04-02','Gio Cliente','847329324');
Insert into SYSTEM.INFOCLIENTE (IDCLIENTE,TIPOCLIENTE,NOMBRETIPOCLIENTE,PATENTE,VENCIMIENTO,NOMBRECLIENTE,NIT) values ('5676896','3','Mayorista','https://imgv2-1-f.scribdassets.com/img/document/420363071/original/3257a152cc/1647370420?v=1','2023-03-31','Jorge Guerrero','5676896');
Insert into SYSTEM.INFOCLIENTE (IDCLIENTE,TIPOCLIENTE,NOMBRETIPOCLIENTE,PATENTE,VENCIMIENTO,NOMBRECLIENTE,NIT) values ('4567890','2','Grande','https://imgv2-1-f.scribdassets.com/img/document/420363071/original/3257a152cc/1647370420?v=1','2023-02-11','Javier López','4567890');
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."CLIENTES_PK" ON "SYSTEM"."CLIENTES" ("NIT") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index DISPOSITIVOS_INDIVIDUALES_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."DISPOSITIVOS_INDIVIDUALES_PK" ON "SYSTEM"."DISPOSITIVOS_INDIVIDUALES" ("SERIE_DISPOSITIVO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."FACTURAS_PK" ON "SYSTEM"."FACTURAS" ("ID_ENTRADA_FACTURA") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index FICHAS_CLIENTES_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."FICHAS_CLIENTES_PK" ON "SYSTEM"."FICHAS_CLIENTES" ("NIT") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index IMAGENES_DISPOSITIVOS_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."IMAGENES_DISPOSITIVOS_PK" ON "SYSTEM"."IMAGENES_DISPOSITIVOS" ("ID_IMAGEN") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSAUX" ;
--------------------------------------------------------
--  DDL for Index MAPEOTABLA_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."MAPEOTABLA_PK" ON "SYSTEM"."MAPEOTABLA" ("IDINVENTARIO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."MARCAS_PK" ON "SYSTEM"."MARCAS" ("ID_MARCA") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
--  DDL for Index ORDENES_COMPRA_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."ORDENES_COMPRA_PK" ON "SYSTEM"."ORDENES_COMPRA" ("ID_ORDEN") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."PEDIDOS_PK" ON "SYSTEM"."PEDIDOS" ("IDPEDIDO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSAUX" ;
--------------------------------------------------------
--  DDL for Index SMARTWATCH_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."SMARTWATCH_PK" ON "SYSTEM"."SMARTWATCH" ("ID_INVENTARIO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  PARALLEL (DEGREE 0 INSTANCES 0) ;
--------------------------------------------------------
--  DDL for Index SYS_IL0000015719C00009$$
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."SYS_IL0000015719C00009$$" ON "SYSTEM"."LOGSTDBY$EVENTS" (
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 16384 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  ...
  PARALLEL (DEGREE 0 INSTANCES 0) ;
--------------------------------------------------------
--  DDL for Index SYS_IL0000015731C00003$$
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."SYS_IL0000015731C00003$$" ON "SYSTEM"."LOGSTDBY$PLSQL" (
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  ...
  PARALLEL (DEGREE 0 INSTANCES 0) ;
--------------------------------------------------------
--  DDL for Index TELEVISORES_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."TELEVISORES_PK" ON "SYSTEM"."TELEVISORES" ("ID_INVENTARIO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."TIPO_CLIENTE_PK" ON "SYSTEM"."TIPO_CLIENTES" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index TIPO_DISPOSITIVO_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."TIPO_DISPOSITIVO_PK" ON "SYSTEM"."TIPO_DISPOSITIVO" ("ID_TIPO_DISPOSITIVO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index TIPO_USUARIOS_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."TIPO_USUARIOS_PK" ON "SYSTEM"."TIPO_USUARIOS" ("ID_TIPO_USUARIO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."VENTAS_PK" ON "SYSTEM"."VENTAS" ("ID_VENTA", "SERIE") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index VIDEOJUEGOS_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."VIDEOJUEGOS_PK" ON "SYSTEM"."VIDEOJUEGOS" ("ID_INVENTARIO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE TRIGGER "SYSTEM"."CLIENTES_TRG" 
...
END;
/
ALTER TRIGGER "SYSTEM"."CLIENTES_TRG" ENABLE;
--------------------------------------------------------
...
BEGIN
  <<COLUMN_SEQUENCES>>
  BEGIN
    IF INSERTING AND :NEW.ID_ENTRADA_FACTURA IS NULL THEN
      SELECT FACTURAS_SEQ.NEXTVAL INTO :NEW.ID_ENTRADA_FACTURA FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
/
...
--------------------------------------------------------
--  DDL for Trigger FICHAS_CLIENTES_TRG
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TRIGGER "SYSTEM"."FICHAS_CLIENTES_TRG" 
BEFORE INSERT ON FICHAS_CLIENTES 
FOR EACH ROW 
BEGIN
  <<COLUMN_SEQUENCES>>
  BEGIN
...
END;
/
ALTER TRIGGER "SYSTEM"."FICHAS_CLIENTES_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger IMAGENES_DISPOSITIVOS_TRG
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TRIGGER "SYSTEM"."IMAGENES_DISPOSITIVOS_TRG" 
BEFORE INSERT ON IMAGENES_DISPOSITIVOS 
FOR EACH ROW 
BEGIN
  <<COLUMN_SEQUENCES>>
  BEGIN
    IF INSERTING AND :NEW.ID_IMAGEN IS NULL THEN
      SELECT IMAGENES_DISPOSITIVOS_SEQ.NEXTVAL INTO :NEW.ID_IMAGEN FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
/
ALTER TRIGGER "SYSTEM"."IMAGENES_DISPOSITIVOS_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger INVENTARIO_TRG
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TRIGGER "SYSTEM"."INVENTARIO_TRG" 
...
END;
/
ALTER TRIGGER "SYSTEM"."INVENTARIO_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger INVENTARIO_TRG1
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TRIGGER "SYSTEM"."INVENTARIO_TRG1" 
BEFORE INSERT ON INVENTARIO 
FOR EACH ROW 
BEGIN
  <<COLUMN_SEQUENCES>>
...
END;
/
ALTER TRIGGER "SYSTEM"."INVENTARIO_TRG1" ENABLE;
--------------------------------------------------------
--  DDL for Trigger MARCAS_TRG
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TRIGGER "SYSTEM"."MARCAS_TRG" 
before insert on marcas 
for each row 
begin
  <<COLUMN_SEQUENCES>>
  BEGIN
    IF INSERTING AND :NEW.ID_MARCA IS NULL THEN
      SELECT MARCAS_SEQ4.NEXTVAL INTO :NEW.ID_MARCA FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
end;
/
ALTER TRIGGER "SYSTEM"."MARCAS_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger ORDENES_COMPRA_TRG
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TRIGGER "SYSTEM"."ORDENES_COMPRA_TRG" 
...
END;
/
ALTER TRIGGER "SYSTEM"."ORDENES_COMPRA_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger PRECIO_VENTA
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TRIGGER "SYSTEM"."PRECIO_VENTA" 
BEFORE INSERT ON INVENTARIO 
...
BEGIN
    IF INSERTING THEN
        select :NEW.precio_lista into precio_v from sys.dual;
        select (:NEW.precio_lista+0.15*:NEW.precio_lista)+0.4*:NEW.precio_lista into precio_v from sys.dual;
        select precio_v+precio_v*0.05+precio_v*0.30+0.12*precio_v+0.05*precio_v into precio_v2 from sys.dual;
        :NEW.precio_lista := precio_v2;
    END IF;
END;
/
ALTER TRIGGER "SYSTEM"."PRECIO_VENTA" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TIPO_CLIENTE_TRG
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TRIGGER "SYSTEM"."TIPO_CLIENTE_TRG" 
BEFORE INSERT ON "TIPO_CLIENTES" 
FOR EACH ROW 
BEGIN
  <<COLUMN_SEQUENCES>>
  BEGIN
    IF INSERTING AND :NEW.ID IS NULL THEN
      SELECT TIPO_CLIENTE_SEQ.NEXTVAL INTO :NEW.ID FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
/
ALTER TRIGGER "SYSTEM"."TIPO_CLIENTE_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TIPO_DISPOSITIVO_TRG
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TRIGGER "SYSTEM"."TIPO_DISPOSITIVO_TRG" 
BEFORE INSERT ON TIPO_DISPOSITIVO 
FOR EACH ROW 
BEGIN
  <<COLUMN_SEQUENCES>>
  BEGIN
    IF INSERTING AND :NEW.ID_TIPO_DISPOSITIVO IS NULL THEN
      SELECT TIPO_DISPOSITIVO_SEQ.NEXTVAL INTO :NEW.ID_TIPO_DISPOSITIVO FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
/
ALTER TRIGGER "SYSTEM"."TIPO_DISPOSITIVO_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger VENTAS_TRG
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TRIGGER "SYSTEM"."VENTAS_TRG" 
before insert on ventas 
for each row 
begin
  <<COLUMN_SEQUENCES>>
  BEGIN
    IF INSERTING AND :NEW.ID_VENTA IS NULL THEN
      SELECT VENTAS_SEQ.NEXTVAL INTO :NEW.ID_VENTA FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
end;
/
ALTER TRIGGER "SYSTEM"."VENTAS_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger CLIENTES_TRG
--------------------------------------------------------
...
ALTER TRIGGER "SYSTEM"."VENTAS_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Procedure ACTUALIZARDISP
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."ACTUALIZARDISP" 
(
  nserie in varchar2 
) as 
begin
    update dispositivos_individuales set vendido = 0 where serie_dispositivo = nserie; 
...
/
--------------------------------------------------------
--  DDL for Procedure ACTUALIZARESTADO
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."ACTUALIZARESTADO" 
(
  id_p in int 
, estado_p in varchar2 
, fecha_p in varchar2 
) as 
begin
   update pedidos set estado = estado_p, fechaentrega=fecha_p where idpedido = id_p; 
...
/
--------------------------------------------------------
--  DDL for Procedure CAMBIOPERMISOS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."CAMBIOPERMISOS" 
(
  nid in int 
, naccion in int 
) as 
begin
  ...
  declare idv int;
  begin
       select tipo_usuario into idv FROM usuarios where id_usuario = nid;
  
      IF naccion = 2 then
        delete from usuarios where id_usuario = nid;
      Else
        if idv = 1 then
             update usuarios set tipo_usuario = 2 where id_usuario = nid;
        else
            update usuarios set tipo_usuario = 1 where id_usuario = nid;
        end if;
      end if;
  end;
...
/
--------------------------------------------------------
--  DDL for Procedure CLIENTESUSCRITO
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."CLIENTESUSCRITO" 
(
  nid in number 
, naccion in number
, nfecha in VARCHAR2
...
/
--------------------------------------------------------
--  DDL for Procedure INSERTARINV
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."INSERTARINV" 
(
  ncategoria in int 
, nmarca in int
, nexistencias in int 
...
/
--------------------------------------------------------
--  DDL for Procedure INSERTDI
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."INSERTDI" 
(
  nserie in varchar2 
, nid in int
, nvendido in int
...
begin
  insert into dispositivos_individuales values(nserie, nid, nvendido);
  commit;
end insertdi;
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."INSERTPEDIDO" 
(
  id_p in number 
, fecha_p in varchar2 
, idinv_p in number 
...
, estado_p in varchar2 
, fecha_entrega_p in varchar2 
) as 
begin
  insert into pedidos values (id_p, fecha_p, idinv_p, cantidad_p, estado_p, fecha_entrega_p);
end insertpedido;

/
--------------------------------------------------------
--  DDL for Procedure MARCANUEVA
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."MARCANUEVA" 
(
  marcap in varchar2 
, ipp in varchar2 
) as 
begin
 declare idv int;
     begin
         select id_marca into idv FROM marcas ORDER BY id_marca desc FETCH NEXT 1 ROWS ONLY;
         insert into marcas values(idv+1, marcap, ipp);
...
/
--------------------------------------------------------
--  DDL for Procedure ORDEN_VENTAS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."ORDEN_VENTAS" 
(
  nCredito in char,
  nfecha in VARCHAR2,
  nCategoria in int,
...
begin
  declare idv int;
    ...
    begin
        select count(*) into contarv from ventas;
        
         IF contarv = 0 THEN
              select count(*) into idv from ventas;
         ELSE
             select id_orden into idv FROM ordenes_compra ORDER BY id_orden desc FETCH NEXT 1 ROWS ONLY;
           
         END IF;
         
         select count(*) into contarv2 from dispositivos_individuales where id_inventario = nCategoria and vendido= 0;
         
         IF contarv2 = 0 THEN
              null;
         ELSE
         
            /*select serie_dispositivo into seriev FROM dispositivos_individuales where id_inventario=nCategoria and vendido= 0 FETCH NEXT 1 ROWS ONLY;*/
            insert into ordenes_compra (id_orden, id_cliente, credito, precio, fecha) values (idv+1, nCliente, nCredito, nPrecio, nfecha);
            
        
               
           
                /*insert into ventas (id_venta, id_orden, serie, credito, fecha) values (idv+1, idv+1, seriev, nCredito, nfecha);
                /*delete from dispositivos_individuales where serie_dispositivo = seriev;
                update dispositivos_individuales set vendido = 1 where serie_dispositivo = seriev;*/
            
   
            
           
            insert into facturas (id_factura, id_venta, nit_cliente, precio) values (nFactura, idv+1, nCliente, nPrecio);
...
/
--------------------------------------------------------
--  DDL for Procedure PRUEBAJAVA
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."PRUEBAJAVA" (nIdInventario IN number, nDescripcion IN VARCHAR2)
AS
BEGIN
    update inventario set descripcion = nDescripcion where id_inventario = nIdInventario;
END;


call insertarinv(1,1,0,45.9,'rojo', 'rojo', '1234', 45, '90', 1,1,1, '90', 1,1,1, '90','90','90');

/
--------------------------------------------------------
--  DDL for Procedure VENTA
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."VENTA" 
(
  nCredito in char,
  nfecha in VARCHAR2,
  nCategoria in int,
    ...
    begin
        select count(*) into contarv from ventas;
         ...
         IF contarv = 0 THEN
              select count(*) into idv from ventas;
         ELSE
             select id_venta into idv FROM ventas ORDER BY id_venta desc FETCH NEXT 1 ROWS ONLY;
           
         END IF;
         
         select count(*) into contarv2 from dispositivos_individuales where id_inventario = nCategoria and vendido= 0;
         select id_orden into idv2 from ordenes_compra ORDER BY id_orden desc FETCH NEXT 1 ROWS ONLY;
         
         IF contarv2 = 0 THEN
              null;
         ELSE
         
            select serie_dispositivo into seriev FROM dispositivos_individuales where id_inventario=nCategoria and vendido= 0 offset nOff rows FETCH NEXT 1 ROWS ONLY;
           
                insert into ventas (id_orden, serie, credito, fecha) values (idv2, seriev, nCredito, nfecha);
                /*delete from dispositivos_individuales where serie_dispositivo = seriev;*/
                update dispositivos_individuales set vendido = 1 where serie_dispositivo = seriev;
...
/
--------------------------------------------------------
--  DDL for Procedure VENTAS2
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."VENTAS2" 
(
  nSerie in varchar2 
, nFecha in varchar2 
, nCredito in char
  ...
  declare idv int;
    ...
    begin
         ...
         select id_orden into idv2 from ordenes_compra ORDER BY id_orden desc FETCH NEXT 1 ROWS ONLY;
                ...
                insert into ventas (id_orden, serie, credito, fecha) values (idv2, nSerie, nCredito, nFecha);
            
                update dispositivos_individuales set vendido = 1 where serie_dispositivo = nSerie;
...
/
--------------------------------------------------------
--  DDL for Function DESCUENTO
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."DESCUENTO" 
(
  precio in number 
, descuento in number 
) return number as 
...
/
--------------------------------------------------------
--  DDL for Function DESCUENTO_PRECIO
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."DESCUENTO_PRECIO" (precio_v float, descuento_v float)
return float
is
BEGIN


  return precio_v*(1-descuento_v);
...
/
--------------------------------------------------------
--  DDL for Function DEUDA
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."DEUDA" 
(
  nnit in number 
) return number as 
begin
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CLIENTES" MODIFY ("NIT" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CLIENTES" MODIFY ("TIPO_CLIENTE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CLIENTES" ADD CONSTRAINT "CLIENTES_PK" PRIMARY KEY ("NIT")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
--------------------------------------------------------
--  Constraints for Table DISPOSITIVOS_INDIVIDUALES
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."DISPOSITIVOS_INDIVIDUALES" MODIFY ("VENDIDO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."DISPOSITIVOS_INDIVIDUALES" MODIFY ("ID_INVENTARIO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."DISPOSITIVOS_INDIVIDUALES" MODIFY ("SERIE_DISPOSITIVO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."DISPOSITIVOS_INDIVIDUALES" ADD CONSTRAINT "DISPOSITIVOS_INDIVIDUALES_PK" PRIMARY KEY ("SERIE_DISPOSITIVO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."FACTURAS" MODIFY ("ID_ENTRADA_FACTURA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."FACTURAS" MODIFY ("ID_FACTURA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."FACTURAS" MODIFY ("ID_VENTA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."FACTURAS" MODIFY ("NIT_CLIENTE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."FACTURAS" MODIFY ("PRECIO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."FACTURAS" ADD CONSTRAINT "FACTURAS_PK" PRIMARY KEY ("ID_ENTRADA_FACTURA")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
--------------------------------------------------------
--  Constraints for Table FICHAS_CLIENTES
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."FICHAS_CLIENTES" MODIFY ("NOMBRE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."FICHAS_CLIENTES" MODIFY ("EMAIL" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."FICHAS_CLIENTES" MODIFY ("NIT" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."FICHAS_CLIENTES" MODIFY ("TELEFONO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."FICHAS_CLIENTES" MODIFY ("PATENTE_DE_COMERCIO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."FICHAS_CLIENTES" MODIFY ("FECHA_DE_VENCIMIENTO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."FICHAS_CLIENTES" ADD CONSTRAINT "FICHAS_CLIENTES_PK" PRIMARY KEY ("NIT")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM"  ENABLE;
--------------------------------------------------------
--  Constraints for Table IMAGENES_DISPOSITIVOS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."IMAGENES_DISPOSITIVOS" MODIFY ("ID_IMAGEN" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."IMAGENES_DISPOSITIVOS" MODIFY ("ID_INVENTARIO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."IMAGENES_DISPOSITIVOS" MODIFY ("IMAGEN" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."IMAGENES_DISPOSITIVOS" ADD CONSTRAINT "IMAGENES_DISPOSITIVOS_PK" PRIMARY KEY ("ID_IMAGEN")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."INVENTARIO" MODIFY ("CATEGORIA_DISPOSITIVO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."INVENTARIO" MODIFY ("MARCA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."INVENTARIO" MODIFY ("EXISTENCIAS" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."INVENTARIO" MODIFY ("PRECIO_LISTA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."INVENTARIO" MODIFY ("COLOR" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."INVENTARIO" MODIFY ("DESCRIPCION" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."INVENTARIO" MODIFY ("MODELO" NOT NULL ENABLE);
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."INVENTARIO" MODIFY ("MESES_GARANTIA" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
--  Constraints for Table MAPEOTABLA
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."MAPEOTABLA" MODIFY ("IDINVENTARIO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."MAPEOTABLA" MODIFY ("IDFABRICA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."MAPEOTABLA" MODIFY ("MARCA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."MAPEOTABLA" ADD CONSTRAINT "MAPEOTABLA_PK" PRIMARY KEY ("IDINVENTARIO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."MARCAS" MODIFY ("IP" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."MARCAS" MODIFY ("ID_MARCA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."MARCAS" MODIFY ("NOMBRE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."MARCAS" ADD CONSTRAINT "MARCAS_PK" PRIMARY KEY ("ID_MARCA")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."ORDENES_COMPRA" MODIFY ("ID_ORDEN" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."ORDENES_COMPRA" MODIFY ("ID_CLIENTE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."ORDENES_COMPRA" MODIFY ("CREDITO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."ORDENES_COMPRA" MODIFY ("PRECIO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."ORDENES_COMPRA" MODIFY ("FECHA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."ORDENES_COMPRA" ADD CONSTRAINT "ORDENES_COMPRA_PK" PRIMARY KEY ("ID_ORDEN")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."PEDIDOS" MODIFY ("IDPEDIDO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PEDIDOS" MODIFY ("FECHA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PEDIDOS" MODIFY ("IDINVENTARIO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PEDIDOS" MODIFY ("CANTIDAD" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PEDIDOS" MODIFY ("ESTADO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PEDIDOS" ADD CONSTRAINT "PEDIDOS_PK" PRIMARY KEY ("IDPEDIDO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
--  Constraints for Table SMARTWATCH
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."SMARTWATCH" MODIFY ("ID_INVENTARIO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SMARTWATCH" MODIFY ("PULGADAS_PANTALLA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SMARTWATCH" MODIFY ("SISTEMA_OPERATIVO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SMARTWATCH" MODIFY ("RAM_MB" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SMARTWATCH" MODIFY ("MEMORIA_GB" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SMARTWATCH" ADD CONSTRAINT "SMARTWATCH_PK" PRIMARY KEY ("ID_INVENTARIO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
--  Constraints for Table TELEVISORES
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."TELEVISORES" MODIFY ("ID_INVENTARIO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."TELEVISORES" MODIFY ("RESOLUCION" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."TELEVISORES" MODIFY ("BITS_PROFUNDIDAD" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."TELEVISORES" MODIFY ("PULGADAS_PANTALLA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."TELEVISORES" MODIFY ("ENTRADAS_HDMI" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."TELEVISORES" ADD CONSTRAINT "TELEVISORES_PK" PRIMARY KEY ("ID_INVENTARIO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
--------------------------------------------------------
--  Constraints for Table TIPO_CLIENTES
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."TIPO_CLIENTES" MODIFY ("NOMBRE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."TIPO_CLIENTES" MODIFY ("DESCUENTO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."TIPO_CLIENTES" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."TIPO_CLIENTES" ADD CONSTRAINT "TIPO_CLIENTE_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
--------------------------------------------------------
--  Constraints for Table TIPO_DISPOSITIVO
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."TIPO_DISPOSITIVO" MODIFY ("NOMBRE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."TIPO_DISPOSITIVO" MODIFY ("ID_TIPO_DISPOSITIVO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."TIPO_DISPOSITIVO" ADD CONSTRAINT "TIPO_DISPOSITIVO_PK" PRIMARY KEY ("ID_TIPO_DISPOSITIVO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
--------------------------------------------------------
--  Constraints for Table TIPO_USUARIOS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."TIPO_USUARIOS" MODIFY ("ID_TIPO_USUARIO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."TIPO_USUARIOS" MODIFY ("NOMBRE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."TIPO_USUARIOS" ADD CONSTRAINT "TIPO_USUARIOS_PK" PRIMARY KEY ("ID_TIPO_USUARIO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."USUARIOS" MODIFY ("TIPO_USUARIO" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."VENTAS" MODIFY ("ID_VENTA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."VENTAS" MODIFY ("ID_ORDEN" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."VENTAS" MODIFY ("SERIE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."VENTAS" MODIFY ("CREDITO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."VENTAS" MODIFY ("FECHA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."VENTAS" ADD CONSTRAINT "VENTAS_PK" PRIMARY KEY ("ID_VENTA", "SERIE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."VIDEOJUEGOS" MODIFY ("ID_INVENTARIO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."VIDEOJUEGOS" MODIFY ("MAX_JUGADORES" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."VIDEOJUEGOS" MODIFY ("GRAFICOS" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."VIDEOJUEGOS" MODIFY ("CONSOLA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."VIDEOJUEGOS" ADD CONSTRAINT "VIDEOJUEGOS_PK" PRIMARY KEY ("ID_INVENTARIO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CLIENTES" ADD CONSTRAINT "FOREIGN_KEYCTC" FOREIGN KEY ("TIPO_CLIENTE")
	  REFERENCES "SYSTEM"."TIPO_CLIENTES" ("ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table DISPOSITIVOS_INDIVIDUALES
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."DISPOSITIVOS_INDIVIDUALES" ADD CONSTRAINT "DISPOSITIVOS_INDIVIDUALES_FK1" FOREIGN KEY ("ID_INVENTARIO")
	  REFERENCES "SYSTEM"."INVENTARIO" ("ID_INVENTARIO") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table FICHAS_CLIENTES
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."FICHAS_CLIENTES" ADD CONSTRAINT "FICHAS_CLIENTES_FK2" FOREIGN KEY ("NIT")
	  REFERENCES "SYSTEM"."CLIENTES" ("NIT") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table IMAGENES_DISPOSITIVOS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."IMAGENES_DISPOSITIVOS" ADD CONSTRAINT "IMAGENES_DISPOSITIVOS_FK1" FOREIGN KEY ("ID_INVENTARIO")
	  REFERENCES "SYSTEM"."INVENTARIO" ("ID_INVENTARIO") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table INVENTARIO
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."INVENTARIO" ADD CONSTRAINT "INVENTARIO_FK1" FOREIGN KEY ("MARCA")
	  REFERENCES "SYSTEM"."MARCAS" ("ID_MARCA") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table MAPEOTABLA
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."MAPEOTABLA" ADD CONSTRAINT "MAPEOTABLA_FK3" FOREIGN KEY ("IDINVENTARIO")
	  REFERENCES "SYSTEM"."INVENTARIO" ("ID_INVENTARIO") ENABLE;
  ALTER TABLE "SYSTEM"."MAPEOTABLA" ADD CONSTRAINT "MAPEOTABLA_FK4" FOREIGN KEY ("MARCA")
	  REFERENCES "SYSTEM"."MARCAS" ("ID_MARCA") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."PEDIDOS" ADD CONSTRAINT "PEDIDOS_FK1" FOREIGN KEY ("IDINVENTARIO")
	  REFERENCES "SYSTEM"."INVENTARIO" ("ID_INVENTARIO") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table SMARTWATCH
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."SMARTWATCH" ADD CONSTRAINT "SMARTWATCH_FK1" FOREIGN KEY ("ID_INVENTARIO")
	  REFERENCES "SYSTEM"."INVENTARIO" ("ID_INVENTARIO") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table TELEVISORES
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."TELEVISORES" ADD CONSTRAINT "TELEVISORES_FK1" FOREIGN KEY ("ID_INVENTARIO")
	  REFERENCES "SYSTEM"."INVENTARIO" ("ID_INVENTARIO") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table USUARIOS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."USUARIOS" ADD CONSTRAINT "USUARIOS_FK1" FOREIGN KEY ("TIPO_USUARIO")
	  REFERENCES "SYSTEM"."TIPO_USUARIOS" ("ID_TIPO_USUARIO") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table VENTAS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."VENTAS" ADD CONSTRAINT "VENTAS_FK1" FOREIGN KEY ("SERIE")
	  REFERENCES "SYSTEM"."DISPOSITIVOS_INDIVIDUALES" ("SERIE_DISPOSITIVO") ENABLE;
  ALTER TABLE "SYSTEM"."VENTAS" ADD CONSTRAINT "VENTAS_FK2" FOREIGN KEY ("ID_ORDEN")
	  REFERENCES "SYSTEM"."ORDENES_COMPRA" ("ID_ORDEN") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table VIDEOJUEGOS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."VIDEOJUEGOS" ADD CONSTRAINT "VIDEOJUEGOS_FK1" FOREIGN KEY ("ID_INVENTARIO")
	  REFERENCES "SYSTEM"."INVENTARIO" ("ID_INVENTARIO") ENABLE;
