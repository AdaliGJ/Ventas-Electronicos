--------------------------------------------------------
-- Archivo creado  - viernes-marzo-18-2022   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SYSTEM"."CLIENTES_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 41 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SYSTEM"."MARCAS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SYSTEM"."USUARIOS_SEQ2"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into SYSTEM.CLIENTES (ID_CLIENTE,PASSWORD,TIPO_CLIENTE) values ('1','1234','1');
Insert into SYSTEM.CLIENTES (ID_CLIENTE,PASSWORD,TIPO_CLIENTE) values ('2','ee','2');
Insert into SYSTEM.CLIENTES (ID_CLIENTE,PASSWORD,TIPO_CLIENTE) values ('3','erwewe','1');
Insert into SYSTEM.CLIENTES (ID_CLIENTE,PASSWORD,TIPO_CLIENTE) values ('21','12','1');
...
SET DEFINE OFF;
Insert into SYSTEM.FICHAS_CLIENTES (ID_CLIENTE,NOMBRE,NIT,EMAIL,TELEFONO,PATENTE_DE_COMERCIO,FECHA_DE_VENCIMIENTO) values ('1','jaime','8434832','juan@gmail.com','12345678','34323243',to_date('10/08/22','DD/MM/RR'));
...
Insert into SYSTEM.INVENTARIO (ID_INVENTARIO,CATEGORIA_DISPOSITIVO,MARCA,EXISTENCIAS,PRECIO_LISTA,COLOR,DESCRIPCION,MODELO,MESES_GARANTIA) values ('4','1','2','0','100','rojo','dsdsaddasd','sadsdsad','12');
...
Insert into SYSTEM.CATALOGO (IDTIPODISPOSITIVO,TIPODISPOSITIVO,IDINVENTARIO,CATEGORIADISPOSITIVO,MARCA,EXISTENCIAS,PRECIOLISTA,COLOR,DESCRIPCION,MODELO,MESESGARANTIA,NOMBREMARCA) values ('1','Televisor','4','1','2','0','100','rojo','dsdsaddasd','sadsdsad','12','LG');
...
Insert into SYSTEM.IMGS (TIPODISPOSITIVO,NOMBREMARCA,MODELO,IDINVENTARIO,DESCRIPCION,PRECIOLISTA,IMAGEN) values ('Televisor','LG','sadsdsad','4','dsdsaddasd','100','https://www.tecnologia-informatica.com/wp-content/uploads/2018/07/funciones-de-la-computadora-1.jpeg');
...
SET DEFINE OFF;
Insert into SYSTEM.INFOCLIENTE (IDCLIENTE,TIPOCLIENTE,NOMBRETIPOCLIENTE,PATENTE,VENCIMIENTO,NOMBRECLIENTE,NIT) values ('1','1','Individual','34323243',to_date('10/08/22','DD/MM/RR'),'jaime','8434832');
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE TRIGGER "SYSTEM"."USUARIOS_TRG1" 
BEFORE INSERT ON USUARIOS 
FOR EACH ROW 
BEGIN
  <<COLUMN_SEQUENCES>>
...
END;
/
ALTER TRIGGER "SYSTEM"."USUARIOS_TRG1" ENABLE;
--------------------------------------------------------
--  DDL for Trigger USUARIOS_TRG2
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TRIGGER "SYSTEM"."USUARIOS_TRG2" 
BEFORE INSERT ON USUARIOS 
FOR EACH ROW 
BEGIN
  <<COLUMN_SEQUENCES>>
  BEGIN
    IF INSERTING AND :NEW.ID_USUARIO IS NULL THEN
      SELECT USUARIOS_SEQ2.NEXTVAL INTO :NEW.ID_USUARIO FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
/
ALTER TRIGGER "SYSTEM"."USUARIOS_TRG2" ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CLIENTES" MODIFY ("PASSWORD" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."USUARIOS" ADD CONSTRAINT "USUARIOS_FK1" FOREIGN KEY ("ID_USUARIO")
