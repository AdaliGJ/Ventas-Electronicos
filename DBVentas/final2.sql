...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SYSTEM"."FACTURAS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 61 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
Insert into SYSTEM.DISPOSITIVOS_INDIVIDUALES (SERIE_DISPOSITIVO,ID_INVENTARIO,VENDIDO) values ('53423','7','0');
...
SET DEFINE OFF;
Insert into SYSTEM.MARCAS (ID_MARCA,NOMBRE) values ('1','Samsung');
Insert into SYSTEM.MARCAS (ID_MARCA,NOMBRE) values ('2','LG');
Insert into SYSTEM.MARCAS (ID_MARCA,NOMBRE) values ('46','Nintendo');
Insert into SYSTEM.MARCAS (ID_MARCA,NOMBRE) values ('45','Sony');
...
BEGIN
  ...
  BEGIN
    IF INSERTING AND :NEW.ID_MARCA IS NULL THEN
      SELECT MARCAS_SEQ.NEXTVAL INTO :NEW.ID_MARCA FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
/
