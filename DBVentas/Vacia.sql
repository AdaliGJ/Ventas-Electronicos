...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SYSTEM"."FACTURAS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 241 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."JAVA$JVM$STATUS" SHARING=METADATA 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."JAVANAMESTATUS$" 
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table JAVA$RMJVM$AUX
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."JAVA$RMJVM$AUX" SHARING=METADATA 
   (	"OBJ#" NUMBER
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table JAVA$RMJVM$AUX2
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."JAVA$RMJVM$AUX2" SHARING=METADATA 
   (	"NAME" VARCHAR2(128 BYTE)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."JAVA$RMJVM$AUX3" SHARING=METADATA 
   (	"OBJ#" NUMBER
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table JAVA$RMJVM$AUX4
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."JAVA$RMJVM$AUX4" SHARING=METADATA 
   (	"NAME" VARCHAR2(128 BYTE), 
	"TYPE#" NUMBER
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table JAVASNM_TMP$
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."JAVASNM_TMP$" 
   (	"SHORT" VARCHAR2(128 BYTE), 
	"LONGNAME" LONG RAW, 
	"LONGDBCS" VARCHAR2(4000 BYTE)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
...
;
--------------------------------------------------------
--  DDL for View JAVA$RMJVM$AUX4V
--------------------------------------------------------

  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "SYSTEM"."JAVA$RMJVM$AUX4V" ("NAME", "TYPE#") AS 
  select "NAME","TYPE#" from java$rmjvm$aux4
;
--------------------------------------------------------
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.JAVA$JVM$STATUS
SET DEFINE OFF;
REM INSERTING into SYSTEM.JAVANAMESTATUS$
SET DEFINE OFF;
Insert into SYSTEM.JAVANAMESTATUS$ (PHASE,IDENTIFIER_LENGTH) values ('SYNONYMS','30');
Insert into SYSTEM.JAVANAMESTATUS$ (PHASE,IDENTIFIER_LENGTH) values ('JAVA','30');
REM INSERTING into SYSTEM.JAVA$RMJVM$AUX
SET DEFINE OFF;
REM INSERTING into SYSTEM.JAVA$RMJVM$AUX2
SET DEFINE OFF;
REM INSERTING into SYSTEM.JAVA$RMJVM$AUX3
SET DEFINE OFF;
REM INSERTING into SYSTEM.JAVA$RMJVM$AUX4
SET DEFINE OFF;
REM INSERTING into SYSTEM.JAVASNM_TMP$
SET DEFINE OFF;
...
SET DEFINE OFF;
Insert into SYSTEM.MARCAS (ID_MARCA,NOMBRE,IP) values ('2','Nintendo','localhost');
...
SET DEFINE OFF;
Insert into SYSTEM.TIPO_DISPOSITIVO (ID_TIPO_DISPOSITIVO,NOMBRE) values ('8','Electrodoméstico');
...
SET DEFINE OFF;
Insert into SYSTEM.USUARIOS (ID_USUARIO,TIPO_USUARIO,PASSWORD,NOMBRE) values ('12345678','1','1234','luis admin');
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.JAVA$RMJVM$AUX4V
SET DEFINE OFF;
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSAUX" ;
--------------------------------------------------------
--  DDL for Index MAPEOTABLA_PK1
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."MAPEOTABLA_PK1" ON "SYSTEM"."MAPEOTABLA" ("IDFABRICA") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
/
--------------------------------------------------------
--  DDL for Package INITJVMAUX
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE PACKAGE "SYSTEM"."INITJVMAUX" authid current_user is
...
/
--------------------------------------------------------
--  DDL for Package JVMFCB
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE PACKAGE "SYSTEM"."JVMFCB" authid current_user is
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE PACKAGE "SYSTEM"."RMJVM" authid current_user is
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE PACKAGE BODY "SYSTEM"."INITJVMAUX" is
...
/
--------------------------------------------------------
--  DDL for Package Body JVMFCB
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE PACKAGE BODY "SYSTEM"."JVMFCB" is
...
/
--------------------------------------------------------
--  DDL for Package Body RMJVM
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE PACKAGE BODY "SYSTEM"."RMJVM" is
...
--------------------------------------------------------
--  Constraints for Table JAVASNM_TMP$
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."JAVASNM_TMP$" MODIFY ("SHORT" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."JAVASNM_TMP$" MODIFY ("LONGNAME" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."MAPEOTABLA" ADD CONSTRAINT "MAPEOTABLA_PK" PRIMARY KEY ("IDFABRICA")
  USING INDEX (CREATE UNIQUE INDEX "SYSTEM"."MAPEOTABLA_PK1" ON "SYSTEM"."MAPEOTABLA" ("IDFABRICA") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
