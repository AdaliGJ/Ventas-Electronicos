...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SYSTEM"."FACTURAS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SYSTEM"."IMAGENES_DISPOSITIVOS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SYSTEM"."INVENTARIO_SEQ1"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into SYSTEM.CLIENTES (NIT,TIPO_CLIENTE) values ('1','1');
...
Insert into SYSTEM.CLIENTES (NIT,TIPO_CLIENTE) values ('85690872','3');
...
SET DEFINE OFF;
Insert into SYSTEM.IMAGENES_DISPOSITIVOS (ID_IMAGEN,ID_INVENTARIO,IMAGEN) values ('1','3','https://cloudfront-us-east-1.images.arcpublishing.com/infobae/XSTNQA7FMBGMHJT5BDADJSLOQY.jpg');
Insert into SYSTEM.IMAGENES_DISPOSITIVOS (ID_IMAGEN,ID_INVENTARIO,IMAGEN) values ('2','4','https://www.tecnologia-informatica.com/wp-content/uploads/2018/07/funciones-de-la-computadora-1.jpeg');
Insert into SYSTEM.IMAGENES_DISPOSITIVOS (ID_IMAGEN,ID_INVENTARIO,IMAGEN) values ('4','1','https://ichef.bbci.co.uk/news/640/amz/worldservice/live/assets/images/2015/08/28/150828082855_mario_nintendo_624x351_nintendo.jpg');
REM INSERTING into SYSTEM.INVENTARIO
SET DEFINE OFF;
Insert into SYSTEM.INVENTARIO (ID_INVENTARIO,CATEGORIA_DISPOSITIVO,MARCA,EXISTENCIAS,PRECIO_LISTA,COLOR,DESCRIPCION,MODELO,MESES_GARANTIA) values ('3','1','1','100','49,56','Verde','Una compu efectiva','ABC2','12');
Insert into SYSTEM.INVENTARIO (ID_INVENTARIO,CATEGORIA_DISPOSITIVO,MARCA,EXISTENCIAS,PRECIO_LISTA,COLOR,DESCRIPCION,MODELO,MESES_GARANTIA) values ('4','1','2','34','40','rojo','rojo','dfdsfds','45');
Insert into SYSTEM.INVENTARIO (ID_INVENTARIO,CATEGORIA_DISPOSITIVO,MARCA,EXISTENCIAS,PRECIO_LISTA,COLOR,DESCRIPCION,MODELO,MESES_GARANTIA) values ('1','2','1','1','188,48','rojo','Videojuego divertido','thold','3');
Insert into SYSTEM.INVENTARIO (ID_INVENTARIO,CATEGORIA_DISPOSITIVO,MARCA,EXISTENCIAS,PRECIO_LISTA,COLOR,DESCRIPCION,MODELO,MESES_GARANTIA) values ('5','3','1','0','106,02','verde','dsa','67','23');
...
SET DEFINE OFF;
Insert into SYSTEM.TELEVISORES (ID_INVENTARIO,RESOLUCION,BITS_PROFUNDIDAD,PULGADAS_PANTALLA,ENTRADAS_HDMI) values ('4','HD','67','42','2');
Insert into SYSTEM.TELEVISORES (ID_INVENTARIO,RESOLUCION,BITS_PROFUNDIDAD,PULGADAS_PANTALLA,ENTRADAS_HDMI) values ('3','HD','56','32','1');
...
SET DEFINE OFF;
Insert into SYSTEM.VIDEOJUEGOS (ID_INVENTARIO,MAX_JUGADORES,GRAFICOS,CONSOLA) values ('1','2','4K','Nintendo');
REM INSERTING into SYSTEM.CATALOGO
SET DEFINE OFF;
Insert into SYSTEM.CATALOGO (IDTIPODISPOSITIVO,TIPODISPOSITIVO,IDINVENTARIO,CATEGORIADISPOSITIVO,MARCA,EXISTENCIAS,PRECIOLISTA,COLOR,DESCRIPCION,MODELO,MESESGARANTIA,NOMBREMARCA) values ('1','Televisor','3','1','1','100','49,56','Verde','Una compu efectiva','ABC2','12','Samsung');
Insert into SYSTEM.CATALOGO (IDTIPODISPOSITIVO,TIPODISPOSITIVO,IDINVENTARIO,CATEGORIADISPOSITIVO,MARCA,EXISTENCIAS,PRECIOLISTA,COLOR,DESCRIPCION,MODELO,MESESGARANTIA,NOMBREMARCA) values ('1','Televisor','4','1','2','34','40','rojo','rojo','dfdsfds','45','LG');
Insert into SYSTEM.CATALOGO (IDTIPODISPOSITIVO,TIPODISPOSITIVO,IDINVENTARIO,CATEGORIADISPOSITIVO,MARCA,EXISTENCIAS,PRECIOLISTA,COLOR,DESCRIPCION,MODELO,MESESGARANTIA,NOMBREMARCA) values ('2','Videojuego','1','2','1','1','188,48','rojo','Videojuego divertido','thold','3','Samsung');
Insert into SYSTEM.CATALOGO (IDTIPODISPOSITIVO,TIPODISPOSITIVO,IDINVENTARIO,CATEGORIADISPOSITIVO,MARCA,EXISTENCIAS,PRECIOLISTA,COLOR,DESCRIPCION,MODELO,MESESGARANTIA,NOMBREMARCA) values ('3','Smartwatch','5','3','1','0','106,02','verde','dsa','67','23','Samsung');
REM INSERTING into SYSTEM.DISPOSITIVOSVENDIDOS
SET DEFINE OFF;
REM INSERTING into SYSTEM.IMGS
SET DEFINE OFF;
Insert into SYSTEM.IMGS (TIPODISPOSITIVO,NOMBREMARCA,MODELO,IDINVENTARIO,DESCRIPCION,PRECIOLISTA,IMAGEN) values ('Televisor','Samsung','ABC2','3','Una compu efectiva','49,56','https://cloudfront-us-east-1.images.arcpublishing.com/infobae/XSTNQA7FMBGMHJT5BDADJSLOQY.jpg');
Insert into SYSTEM.IMGS (TIPODISPOSITIVO,NOMBREMARCA,MODELO,IDINVENTARIO,DESCRIPCION,PRECIOLISTA,IMAGEN) values ('Televisor','LG','dfdsfds','4','rojo','40','https://www.tecnologia-informatica.com/wp-content/uploads/2018/07/funciones-de-la-computadora-1.jpeg');
Insert into SYSTEM.IMGS (TIPODISPOSITIVO,NOMBREMARCA,MODELO,IDINVENTARIO,DESCRIPCION,PRECIOLISTA,IMAGEN) values ('Videojuego','Samsung','thold','1','Videojuego divertido','188,48','https://ichef.bbci.co.uk/news/640/amz/worldservice/live/assets/images/2015/08/28/150828082855_mario_nintendo_624x351_nintendo.jpg');
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."FICHAS_CLIENTES_PK" ON "SYSTEM"."FICHAS_CLIENTES" ("ID_CLIENTE") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."FICHAS_CLIENTES" ADD CONSTRAINT "FICHAS_CLIENTES_PK" PRIMARY KEY ("ID_CLIENTE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."FICHAS_CLIENTES" ADD CONSTRAINT "FICHAS_CLIENTES_FK1" FOREIGN KEY ("ID_CLIENTE")
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."ORDENES_COMPRA" ADD CONSTRAINT "ORDENES_COMPRA_FK1" FOREIGN KEY ("ID_CLIENTE")
	  REFERENCES "SYSTEM"."CLIENTES" ("NIT") ENABLE;
--------------------------------------------------------
