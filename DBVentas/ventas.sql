--------------------------------------------------------
-- Archivo creado  - sábado-marzo-12-2022   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SYSTEM"."CLIENTES_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SYSTEM"."MARCAS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SYSTEM"."TIPO_DISPOSITIVO_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "SYSTEM"."CATALOGO" ("ID_TIPO_DISPOSITIVO", "TIPO_DISPOSITIVO", "ID_INVENTARIO", "CATEGORIA_DISPOSITIVO", "MARCA", "EXISTENCIAS", "PRECIO_LISTA", "COLOR", "DESCRIPCION", "MODELO", "NOMBRE_MARCA") AS 
  select tdi."ID_TIPO_DISPOSITIVO",tdi."TIPO_DISPOSITIVO",tdi."ID_INVENTARIO",tdi."CATEGORIA_DISPOSITIVO",tdi."MARCA",tdi."EXISTENCIAS",tdi."PRECIO_LISTA",tdi."COLOR",tdi."DESCRIPCION",tdi."MODELO", m.nombre nombre_marca from (select td.id_tipo_dispositivo, td.nombre tipo_dispositivo, i.* from tipo_dispositivo td inner join inventario i on td.id_tipo_dispositivo=i.categoria_dispositivo) tdi inner join marcas m on tdi.marca = m.id_marca
;
--------------------------------------------------------
--  DDL for View DISPOSITIVOS_VENDIDOS
--------------------------------------------------------

  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "SYSTEM"."DISPOSITIVOS_VENDIDOS" ("SERIE", "FECHA", "ID_PROPIETARIO", "NOMBRE_PROPIETARIO", "DISPOSITIVO") AS 
  select vc.serie, vc.fecha, vc.id_propietario, vc.nombre_propietario, di.id_inventario dispositivo from (select v.serie, v.fecha, cs.* from (select fc.id_cliente id_propietario, fc.nombre nombre_propietario, o.id_orden from fichas_clientes fc inner join ordenes_compra o on fc.id_cliente=o.id_cliente) cs inner join ventas v on cs.id_orden=v.id_orden) vc inner join dispositivos_individuales di on di.serie_dispositivo = vc.serie
;
--------------------------------------------------------
--  DDL for View INFO_CLIENTE
--------------------------------------------------------

  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "SYSTEM"."INFO_CLIENTE" ("ID_CLIENTE", "TIPO_CLIENTE", "NOMBRE_TIPO_CLIENTE", "PATENTE_DE_COMERCIO", "FECHA_DE_VENCIMIENTO", "NOMBRE_CLIENTE", "NIT") AS 
  select cs."ID_CLIENTE",cs."TIPO_CLIENTE",cs."NOMBRE_TIPO_CLIENTE", fc.patente_de_comercio,fc.fecha_de_vencimiento, fc.nombre nombre_cliente, fc.nit from (select c.id_cliente, c.tipo_cliente, tc.nombre nombre_tipo_cliente from clientes c inner join tipo_clientes tc on c.tipo_cliente=tc.id) cs inner join fichas_clientes fc on fc.id_cliente = cs.id_cliente
;
--------------------------------------------------------
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.DISPOSITIVOS_VENDIDOS
SET DEFINE OFF;
REM INSERTING into SYSTEM.INFO_CLIENTE
SET DEFINE OFF;
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."USUARIOS" MODIFY ("CONTRASEÑA" NOT NULL ENABLE);
