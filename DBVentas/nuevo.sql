--------------------------------------------------------
-- Archivo creado  - viernes-abril-15-2022   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SYSTEM"."FACTURAS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 81 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into SYSTEM.DISPOSITIVOS_INDIVIDUALES (SERIE_DISPOSITIVO,ID_INVENTARIO,VENDIDO) values ('5664','1','1');
Insert into SYSTEM.DISPOSITIVOS_INDIVIDUALES (SERIE_DISPOSITIVO,ID_INVENTARIO,VENDIDO) values ('fwst','2','1');
Insert into SYSTEM.DISPOSITIVOS_INDIVIDUALES (SERIE_DISPOSITIVO,ID_INVENTARIO,VENDIDO) values ('fwe45','1','0');
Insert into SYSTEM.DISPOSITIVOS_INDIVIDUALES (SERIE_DISPOSITIVO,ID_INVENTARIO,VENDIDO) values ('53423','7','1');
Insert into SYSTEM.DISPOSITIVOS_INDIVIDUALES (SERIE_DISPOSITIVO,ID_INVENTARIO,VENDIDO) values ('6785','5','0');
Insert into SYSTEM.DISPOSITIVOS_INDIVIDUALES (SERIE_DISPOSITIVO,ID_INVENTARIO,VENDIDO) values ('yrgr','7','0');
...
SET DEFINE OFF;
Insert into SYSTEM.PEDIDOS (IDPEDIDO,FECHA,IDINVENTARIO,CANTIDAD,ESTADO,FECHAENTREGA) values ('1','22/01/2021','1','23','devuleto','2342/88');
...
SET DEFINE OFF;
Insert into SYSTEM.VENTAS (ID_VENTA,ID_ORDEN,SERIE,CREDITO,FECHA) values ('1','1','fwst','0','2-3-2022');
Insert into SYSTEM.VENTAS (ID_VENTA,ID_ORDEN,SERIE,CREDITO,FECHA) values ('2','2','53423','0','2-3-2022');
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."VENTAS_PK" ON "SYSTEM"."VENTAS" ("ID_VENTA") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
begin
  insert into dispositivos_individuales values(nserie, nid, 0);
  commit;
end insertdi;
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."VENTA" as 
begin
  null;
end venta;
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."VENTAS" ADD CONSTRAINT "VENTAS_PK" PRIMARY KEY ("ID_VENTA")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
